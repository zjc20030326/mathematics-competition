...
逐次使用可得
\[
  \prod\limits_{k=1}^{n}\cos\dfrac{k\pi}{2n+1}
  =2^{-n}
  \dfrac{\prod_{k=1}^{n}\sin\frac{2k\pi}{2n+1}}
        {\prod_{k=1}^{n}\sin\frac{k\pi}{2n+1}}.
\]
...
(1) 模 $3$ 化简得到
\[
  x^4+x^3-1\in\mathbb F_3[x].
\]
它在 $\mathbb F_3$ 中无一次因子；进一步检验唯一可能的首一不可约二次因子可知亦无二次因子，
故在 $\mathbb F_3[x]$ 中不可约。由模素数判别法，原多项式在 $\mathbb Q[x]$ 中不可约。
