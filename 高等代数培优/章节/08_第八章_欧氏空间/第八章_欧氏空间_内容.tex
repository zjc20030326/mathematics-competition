...
其平方范数为
\[
\displaystyle\int_{-1}^{1}(x+x^3)^2\,\mathrm{d}x
=
\dfrac{184}{105}.
\]
故一组标准正交基为
...
若存在非平凡关系
\[
\displaystyle\sum c_i\alpha_i=0,
\]
...
证明 Bessel 不等式
\[
\displaystyle\sum\limits_{i=1}^{k}(\alpha,\alpha_i)^2
\le
\|\alpha\|^2,
\]
并证明
...
若左侧组合为零,则其平方范数
\[
\displaystyle\sum_{i,j}c_ic_j(\alpha_i,\alpha_j)=0.
\]
