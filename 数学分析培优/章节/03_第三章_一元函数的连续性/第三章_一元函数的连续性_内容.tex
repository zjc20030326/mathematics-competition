...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{x\to\infty}f(f(x))=\infty,
    \]
    证明:
    \[
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}[f(x_n+T)-f(x_n)]=0.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}f(x+n)=0,
        \qquad \forall x\in\lbrack 0,+\infty).
    \]
    则
    \[
        \displaystyle\lim\limits_{x\to+\infty}f(x)=0.
    \]
\end{example}
\exampleblank
