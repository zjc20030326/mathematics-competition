...
\begin{solution}
    记原式为 $A_n$.由
    \[
        \sum\limits_{i=1}^{n}\left(1-\dfrac{1}{i}\right)
        =n-H_n,
        \qquad
        ...
        \item 直接应用洛必达法则:
              \[
                  \begin{aligned}
                      ...
                      \lim\limits_{x\to+\infty}
                      \dfrac{
                          2\left(\int_0^x e^{t^2}\,\mathrm{d}t\right)e^{x^2}
                      }{e^{2x^2}}                                     \\
                       & =
                      \lim\limits_{x\to+\infty}
                      \dfrac{2\int_0^x e^{t^2}\,\mathrm{d}t}{e^{x^2}} \\
                       & =
                      \lim\limits_{x\to+\infty}
...
\begin{example}[\markstar]
    已知函数 $f(x)$ 可导,且
    \[
        \lim\limits_{x\to+\infty}\left[f(x)+f'(x)\right]=k,
    \]
    证明:
    \[
...
\begin{solution}
    \begin{enumerate}
        ...
        \item 当 $x>0$ 时,
              ...
              令 $x\to0^+$,由
              \[
                  \lim\limits_{x\to0^+}\dfrac{\ln(1+kx)}{x}=k,
              \]
              得
              \[
                  \lim\limits_{x\to0^+}\dfrac{f(x)}{x}
                  =
...
\begin{theorem}[单调有界原理]
    ...
    \[
        \lim\limits_{n\to\infty}x_n=\sup\{x_n:n\in\mathbb{N}\};
    \]
    若实数列 $\{x_n\}$ 单调递减且有下界,则存在
    \[
        \lim\limits_{n\to\infty}x_n=\inf\{x_n:n\in\mathbb{N}\}.
    \]
...
\begin{theorem}[闭区间套定理]
    ...
    \[
        \bigcap\limits_{n=1}^{\infty}I_n=\{\xi\},
    \]
    且 $a_n\to\xi,b_n\to\xi$.
\end{theorem}
