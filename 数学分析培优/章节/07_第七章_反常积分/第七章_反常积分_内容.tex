...
\begin{solution}
  ...
  \begin{enumerate}
    \item 由 Euler 积分公式
          \[
            \displaystyle\int_0^{+\infty}\dfrac{x^{u-1}}{1+x^v}\,\mathrm{d}x
            =\dfrac{\pi}{v}\csc\dfrac{u\pi}{v}
            \qquad(0<u<v),
          \]
          取 $u=3,v=4$,得
          \[
            \displaystyle\int_0^{+\infty}\dfrac{x^2}{1+x^4}\,\mathrm{d}x
...
\begin{example}
  ...
  \begin{enumerate}
    ...
    \item $\displaystyle\int_a^b\dfrac{\mathrm{d}x}{\sqrt{(x-a)(b-x)}}\,(b>a)$;
    \item $\displaystyle\int_{-1}^{1}\dfrac{\mathrm{d}x}{(a-x)\sqrt{1-x^2}}\,(a>1)$.
  \end{enumerate}
\end{example}
\exampleblank
...
\begin{solution}
  ...
  \begin{enumerate}
    \item 当 $n\in\mathbb{Z}^+$ 时,利用
          ...
          及三角函数的正交性,得到
          \[
            \displaystyle\int_0^{\frac{\pi}{2}}\cos(2nx)\ln(\cos x)\,\mathrm{d}x
            =\dfrac{(-1)^{n+1}\pi}{4n}.
          \]
    ...
    \item 令 $x=\dfrac{a+b}{2}+\dfrac{b-a}{2}\cos\theta$,则
          ...
          从而
          \[
            \displaystyle\int_a^b\dfrac{\mathrm{d}x}{\sqrt{(x-a)(b-x)}}
            =\int_0^\pi\mathrm{d}\theta=\pi.
          \]

    \item 令 $x=\cos\theta$,则
          \[
            \displaystyle\int_{-1}^{1}\dfrac{\mathrm{d}x}{(a-x)\sqrt{1-x^2}}
...
\begin{example}
  ...
  \begin{enumerate}
    ...
    \item $\displaystyle\int_0^1x^n\left(\ln\dfrac{1}{x}\right)^m\,\mathrm{d}x\,(n,m\in\mathbb{N})$.
  \end{enumerate}
\end{example}
\exampleblank
...
\begin{solution}
  ...
  \begin{enumerate}
    \item 令 $t=x+1$,则
          \[
            \displaystyle\int_{-\infty}^{+\infty}\dfrac{\mathrm{d}x}{(x^2+2x+2)^n}
    ...
    \item 令 $x=e^{-t}$,则
          \[
            \displaystyle\int_0^1x^n\left(\ln\dfrac{1}{x}\right)^m\,\mathrm{d}x
...
\begin{example}
  ...
  \begin{enumerate}
    \item
          \[
            \displaystyle\int_0^{+\infty}f\left(ax+\dfrac{b}{x}\right)\,\mathrm{d}x
    ...
    \item
          \[
            \displaystyle\int_0^{+\infty}f\left(\left(Ax-\dfrac{B}{x}\right)^2\right)\,\mathrm{d}x
...
\begin{example}[\markstar]
  证明:
  \[
    \displaystyle\int_1^{+\infty}\left(\dfrac{1}{[x]}-\dfrac{1}{x}\right)\,\mathrm{d}x
...
\begin{solution}
  ...
  \[
    \displaystyle\int_1^{n+1}\left(\dfrac{1}{[x]}-\dfrac{1}{x}\right)\,\mathrm{d}x
...
\begin{solution}
  ...
  \begin{enumerate}
    ...
    \item 分部积分得
          \[
            \displaystyle\int_0^1\dfrac{\arcsin x}{x}\,\mathrm{d}x
            =-\int_0^1\dfrac{\ln x}{\sqrt{1-x^2}}\,\mathrm{d}x
            =\dfrac{\pi}{2}\ln2.
          \]
    \item 由 $\cot x=(\ln\sin x)'$ 分部积分,
          \[
            \displaystyle\int_0^{\frac{\pi}{2}}x\cot x\,\mathrm{d}x
    ...
    \item 因 $\dfrac{\sin x}{1-\cos x}=\cot\dfrac{x}{2}$,令 $x=2t$,得
          \[
            \displaystyle\int_0^\pi\dfrac{x\sin x}{1-\cos x}\,\mathrm{d}x
...
\begin{solution}
  ...
  \begin{enumerate}
    ...
    \item 由阻尼因子 $e^{-\varepsilon x}$ 先计算再令 $\varepsilon\to0^+$,或直接应用
          Froullani 公式,得
          \[
            \displaystyle\int_0^{+\infty}\dfrac{\cos ax-\cos bx}{x}\,\mathrm{d}x
            =\ln\dfrac{b}{a}.
          \]
    ...
    \item 分部积分并注意边界项为零,
          \[
            \displaystyle\int_0^{+\infty}\dfrac{b\sin ax-a\sin bx}{x^2}\,\mathrm{d}x
...
\begin{solution}
  记 Dirichlet 积分
  \[
    \displaystyle\int_0^{+\infty}\dfrac{\sin(cx)}{x}\,\mathrm{d}x=\dfrac{\pi}{2}
    \qquad(c>0).
  \]
  \begin{enumerate}
    \item 分部积分得
          \[
            \displaystyle\int_0^{+\infty}\dfrac{\sin^2x}{x^2}\,\mathrm{d}x
            =\int_0^{+\infty}\dfrac{\sin2x}{x}\,\mathrm{d}x=\dfrac{\pi}{2}.
          \]
    \item 分部积分后利用
          $4\sin^3x\cos x=\sin2x-\dfrac{1}{2}\sin4x$,得
          \[
            \displaystyle\int_0^{+\infty}\dfrac{\sin^4x}{x^2}\,\mathrm{d}x
            =\dfrac{\pi}{4}.
          \]
    \item 连续两次分部积分可得
          \[
            \displaystyle\int_0^{+\infty}\dfrac{\sin^4x}{x^4}\,\mathrm{d}x
            =\dfrac{1}{3}\int_0^{+\infty}\dfrac{\cos2x-\cos4x}{x^2}\,\mathrm{d}x.
          \]
          再分部积分一次,
          \[
            \displaystyle\int_0^{+\infty}\dfrac{\cos2x-\cos4x}{x^2}\,\mathrm{d}x
            =\int_0^{+\infty}\dfrac{-2\sin2x+4\sin4x}{x}\,\mathrm{d}x=\pi,
          \]
          故原积分为 $\dfrac{\pi}{3}$.
    \item 分部积分得
          \[
            \displaystyle\int_0^{+\infty}\dfrac{x-\sin x}{x^3}\,\mathrm{d}x
    ...
    \item 利用
          ...
          以及换元 $u=x-\pi$,可得
          \[
            \displaystyle\int_{-\infty}^{+\infty}\dfrac{\sin x}{x(x-\pi)}\,\mathrm{d}x
            =-\dfrac{1}{\pi}\cdot\pi+\dfrac{1}{\pi}\cdot(-\pi)=-2.
          \]
    \item 令 $u=x^2$,则
          \[
            \displaystyle\int_0^{+\infty}\dfrac{\sin x^2}{x}\,\mathrm{d}x
...
\begin{solution}
  ...
  \begin{enumerate}
    \item
          \[
            \displaystyle\int_0^{+\infty}e^{-x^2}\left(x^2+\dfrac{1}{2}\right)^2\,\mathrm{d}x
            =\dfrac{3\sqrt{\pi}}{4}.
          \]
    \item 当 $a,b\neq0$ 时,换元后得
          \[
            \displaystyle\int_0^{+\infty}\left(e^{-a^2x^2}-e^{-b^2x^2}\right)\,\mathrm{d}x
...
\begin{solution}
  ...
  \begin{enumerate}
    ...
    \item 设 $I=\displaystyle\int_0^{+\infty}e^{-x^2}\,\mathrm{d}x$.对 $n>1$,由 (1) 得
          \[
            \displaystyle\int_0^{\sqrt n}\left(1-\dfrac{x^2}{n}\right)^n\,\mathrm{d}x
            \leq I\leq
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{t\to0^+}\int_{-\infty}^{+\infty}\dfrac{t}{t^2+x^2}f(x)\,\mathrm{d}x.
  \]
\end{example}
\exampleblank
...
\begin{example}
  求极限
  \[
    \displaystyle\lim\limits_{x\to0^+}x^\alpha\int_x^1\dfrac{f(t)}{t^{\alpha+1}}\,\mathrm{d}t,
  \]
...
\begin{example}
  ...
  \[
    \displaystyle\int_a^{+\infty}\varphi(t)\,\mathrm{d}t
  \]
  发散,当 $x\to+\infty$ 时,$f(x)=o(\varphi(x))$.证明:
  \[
    \displaystyle\int_a^{+\infty}f(t)\,\mathrm{d}t
...
\begin{solution}
  ...
  \[
    \displaystyle\limsup\limits_{x\to+\infty}\dfrac{|F(x)|}{\Phi(x)}\leq\varepsilon.
  \]
...
\begin{proposition}[\markstar\ Riemann 引理]
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\int_a^{+\infty}f(x)g(nx)\,\mathrm{d}x
...
\begin{example}
  \begin{enumerate}
    \item 设 $\varphi(x)$ 为有界周期函数,周期为 $T$,且
          ...
          求证:
          \[
            \displaystyle\lim\limits_{n\to\infty}n\int_0^{+\infty}\dfrac{\varphi(t)}{t^2}\,\mathrm{d}t=C;
          \]
...
\begin{solution}
  ...
  \begin{enumerate}
    \item 原资料把积分下限写成 $0$,此时积分与 $n$ 无关,且 $t=0$ 还是奇点,
          ...
          \[
            \displaystyle\lim\limits_{n\to\infty}n\int_n^{+\infty}\dfrac{\varphi(t)}{t^2}\,\mathrm{d}t=C.
          \]
          对这一形式,令 $t=nu$,得到
          \[
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\int_0^{+\infty}f(x)|\sin nx|\,\mathrm{d}x
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{\lambda\to0}\int_{-\infty}^{+\infty}
...
\begin{solution}
  ...
  \[
    \displaystyle\int_{-1}^{1}p(u)\dfrac{f(x+\lambda u)-f(x)}{\lambda}\,\mathrm{d}u.
  \]
...
\begin{remark}
  ...
  \begin{enumerate}
    ...
    \item 该结论还可推广为更一般的情况,$f$ 条件同上,$\varphi(x)$ 在 $\lbrack 0,1\rbrack$ 上常义可积,则
          \[
            \displaystyle\lim\limits_{n\to\infty}\dfrac{1}{n}\sum\limits_{i=1}^{n-1}
...
\begin{example}
  ...
  试证:
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{G_n}{A_n}=\dfrac{2}{e}.
  \]
\end{example}
\exampleblank
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\sqrt[n]{A_n}=2,
    \qquad
...
\begin{example}
  ...
  则
  \[
    \displaystyle\lim\limits_{x\to+\infty}f(x)<1+\dfrac{\pi}{4}.
  \]
\end{example}
\exampleblank
...
\begin{solution}
  ...
  所以 $f$ 有有限极限,并且
  \[
    \displaystyle\lim\limits_{x\to+\infty}f(x)-1
...
\begin{example}
  讨论下列积分的敛散性:
  \begin{enumerate}
    \item $\displaystyle\int_1^{+\infty}\dfrac{\mathrm{d}x}{\sqrt[r]{\ln x}}\,(r>0)$;
...
\begin{example}
  讨论
  \[
    \displaystyle\int_0^\pi\dfrac{\sin^{\alpha-1}x}{|1+k\cos x|^\alpha}\,\mathrm{d}x
  \]
  的敛散性.
\end{example}
\exampleblank
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{x\to+\infty}\dfrac{\ln f(x)}{\ln x}=\lambda.
  \]
...
\begin{example}
  ...
  \[
    \displaystyle\int_{-\infty}^{+\infty}f(x)e^{-\frac{|x|}{k}}\,\mathrm{d}x<M
  \]
...
\begin{example}
  ...
  证明:
  \[
    \displaystyle\int_0^1f(x)\,\mathrm{d}x\text{ 收敛}
...
\begin{solution}
  ...
  由单调收敛定理,
  \[
    \displaystyle\lim\limits_{N\to+\infty}\int_0^1f_N(x)\,\mathrm{d}x
    =\int_0^1f(x)\,\mathrm{d}x,
  \]
...
\begin{solution}
  ...
  \begin{enumerate}
    \item 由 Cauchy--Schwarz 不等式,
          \[
            \displaystyle\int_1^{+\infty}\dfrac{\sqrt{f(x)}}{x^p}\,\mathrm{d}x
...
\begin{example}
  \begin{enumerate}
    \item 设 $f\in C\lbrack 1,+\infty)$,$f(x)>0$,$\displaystyle F(x)=\int_1^xf(t)\,\mathrm{d}t$,若 $\displaystyle\int_1^{+\infty}f(x)\,\mathrm{d}x=+\infty$,则
          \[
            \displaystyle\int_1^{+\infty}\dfrac{f(x)}{F(x)\ln F(x)}\,\mathrm{d}x
          \]
          发散,而
          \[
            \displaystyle\int_2^{+\infty}\dfrac{f(x)}{F(x)\ln^2F(x)}\,\mathrm{d}x
          \]
          收敛;
...
\begin{solution}
  ...
  \begin{enumerate}
    \item 由于 $F'(x)=f(x)$ 且 $F(x)\to+\infty$,取 $x_0$ 使
          $F(x_0)>1$.换元 $u=F(x)$ 得
          \[
            \displaystyle\int_{x_0}^{+\infty}\dfrac{f(x)}{F(x)\ln F(x)}\,\mathrm{d}x
            =\int_{F(x_0)}^{+\infty}\dfrac{\mathrm{d}u}{u\ln u}=+\infty,
          \]
          而
          \[
            \displaystyle\int_{x_0}^{+\infty}\dfrac{f(x)}{F(x)\ln^2F(x)}\,\mathrm{d}x
    ...
    \item 本小题的假设写的是 $F$,积分中却使用 $f$;关于 $F$ 的假设与结论无关,
          ...
          \[
            \displaystyle\int_1^{+\infty}a^xf(a^x)\,\mathrm{d}x
...
\begin{example}
  ...
  \[
    \displaystyle\int_0^{+\infty}\dfrac{1}{f(x)}\,\mathrm{d}x\text{ 收敛}
    \quad\Longleftrightarrow\quad
...
\begin{example}
  ...
  \[
    \displaystyle\int_a^{+\infty}f^2(x)\,\mathrm{d}x,
    \qquad
...
\begin{solution}
  ...
  \[
    \displaystyle\int_a^{+\infty}\eta_R^2(f')^2\,\mathrm{d}x
...
\begin{solution}
  题面末句缺少积分号;按本节语境,应证明
  \[
    \displaystyle\int_1^{+\infty}[f(x)]^{1-\frac{1}{x}}\,\mathrm{d}x
  \]
...
\begin{example}
  \begin{enumerate}
    \item 设 $f(x)>0$($a\leq x<+\infty$),且对任意 $b>a$ 有 $f\in R\lbrack a,b\rbrack$.若对 $x_0>a$,有
          \[
            \displaystyle\lim\limits_{x\to+\infty}\dfrac{f(x+x_0)}{f(x)}=l,
          \]
          则
          \[
    ...
    \item 设 $f\in R\lbrack a,b\rbrack$($\forall b>a$),且 $f(x)>0$($a\leq x<+\infty$),
          \[
            \displaystyle\lim\limits_{x\to+\infty}\dfrac{f(kx)}{f(x)}=l,
            \qquad k>1,
          \]
          则
          \[
...
\begin{proposition}[\markstar]
  ...
  \begin{enumerate}
    ...
    \item
          \[
            \displaystyle\int_0^\infty\dfrac{\sin x}{x^p}\,\mathrm{d}x
            \begin{cases}
              \text{绝对收敛}, & 1<p<2,     \\
              \text{条件收敛}, & 0<p\leq1,  \\
              \text{发散},   & \text{其它},
          ...
          而
          \[
            \displaystyle\int_0^{+\infty}\dfrac{\cos x}{x^p}\,\mathrm{d}x
            \begin{cases}
              \text{条件收敛}, & 0<p<1,     \\
              \text{发散},   & \text{其它}.
            \end{cases}
...
\begin{example}
  证明:积分
  \[
    \displaystyle\int_0^1\left(x\sin\dfrac{1}{x^2}-\dfrac{1}{x}\cos\dfrac{1}{x^2}\right)\,\mathrm{d}x
  \]
  收敛.
\end{example}
\exampleblank
...
\begin{solution}
  令 $t=1/x$,则原积分化为
  \[
    \displaystyle\int_1^{+\infty}\left(\dfrac{\sin t^2}{t^3}-\dfrac{\cos t^2}{t}\right)\,\mathrm{d}t.
  \]
  注意到
  \[
...
\begin{solution}
  ...
  \begin{enumerate}
    ...
    \item 令 $t=1/x$,则
          \[
            \displaystyle\int_0^1x^{-p}\sin\dfrac{1}{x}\,\mathrm{d}x
...
\begin{example}
  积分
  \[
    \displaystyle\int_0^{+\infty}\left[\left(1-\dfrac{\sin x}{x}\right)^{-\frac{1}{3}}-1\right]\,\mathrm{d}x
  \]
  是否收敛?是否绝对收敛?
\end{example}
\exampleblank
...
\begin{example}
  ...
  \[
    \displaystyle\int_0^{+\infty}x^\alpha\sin(x^\beta)\,\mathrm{d}x
  \]
  的绝对收敛性与条件收敛性.
\end{example}
\exampleblank
...
\begin{solution}
  ...
  利用 $f$ 单调递减,
  \[
    \displaystyle\int_{n\pi+\pi/4}^{n\pi+3\pi/4}f(x)\sin^2x\,\mathrm{d}x
...
\begin{example}
  ...
  \[
    \displaystyle\int_a^{+\infty}\sin(f(x))\,\mathrm{d}x
    \quad\text{和}\quad
...
\begin{solution}
  ...
  因此
  \[
    \displaystyle\int_a^{+\infty}f(x)g(x)\,\mathrm{d}x
...
\begin{example}[\markstar]
  讨论积分
  \[
    \displaystyle\int_0^{+\infty}\dfrac{x}{1+x^6\sin^2x}\,\mathrm{d}x
  \]
  的敛散性.
\end{example}
\exampleblank
...
\begin{solution}
  ...
  \[
    \displaystyle\int_{I_n}\dfrac{x}{1+x^6\sin^2x}\,\mathrm{d}x
...
\begin{example}[\markstar]
  讨论积分
  \[
    \displaystyle\int_0^{+\infty}\dfrac{x}{1+x^4\sin^2x}\,\mathrm{d}x
  \]
  的敛散性.
\end{example}
\exampleblank
...
\begin{solution}
  ...
  \[
    \displaystyle\int_{n\pi-n^{-2}}^{n\pi+n^{-2}}
...
\begin{solution}
  ...
  \begin{enumerate}
    ...
    \item 令 $x=e^u$ 及 $h(u)=e^u f(e^u)$.则 $h$ 单调,且
          \[
            \displaystyle\int_{\ln a}^{+\infty}h(u)\,\mathrm{d}u
    ...
    \item 题面中的 $\displaystyle\int_a^x f(x)\,\mathrm{d}x$ 记号有误;
          ...
          \[
            \displaystyle\int_a^{+\infty}xg(x)\,\mathrm{d}x
            =\int_a^{+\infty}f(x)\,\mathrm{d}x
          \]
...
\begin{example}
  \begin{enumerate}
    \item 设 $f\in C\lbrack a,+\infty)$ 且 $\displaystyle\int_a^{+\infty}f(x)\,\mathrm{d}x$ 收敛,则存在数列 $\{x_n\}\subseteq\lbrack a,+\infty)$ 满足
          \[
            \displaystyle\lim\limits_{n\to\infty}x_n=+\infty,
            \qquad
