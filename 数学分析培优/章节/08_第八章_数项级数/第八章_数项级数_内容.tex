...
\begin{example}
    设 $0<x<1$,求如下级数之和:
    \[
        \displaystyle\sum\limits_{n=0}^{\infty}\dfrac{x^{2n}}{1-x^{2n+1}}.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}n(a_n-a_{n+1})
    \]
    之和.
\end{example}
\exampleblank
...
\begin{example}
    设数列 $\{a_n\}$ 满足
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}(a_1+1)(a_2+1)\cdots(a_n+1)=l,
    \]
...
\begin{solution}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}\dfrac{a_n}{P_n}=1-\dfrac{1}{l}.
    \]
...
\begin{solution}
    ...
    利用
    \[
        \displaystyle\sum\limits_{k=1}^{m}\dfrac{1}{2k-1}=H_{2m}-\dfrac{1}{2}H_m,
        \qquad
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 由分组估计
              \[
                  \displaystyle\sum\limits_{n=2^{m-1}+1}^{2^m}\dfrac{1}{n}\geq\dfrac{1}{2},
              \]
              调和级数发散.
    \end{enumerate}
\end{solution}
...
\begin{example}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}\dfrac{a_n}{S_n}
    \]
    发散.
\end{example}
\exampleblank
...
\begin{solution}
    ...
    求和后得到
    \[
        \displaystyle\sum\limits_{n=N}^{m}\dfrac{a_n}{S_n}
...
\begin{example}
    如果
    \[
        \displaystyle\lim\limits_{n\to\infty}a_{n+1}=0,
        \quad
...
\begin{example}
    ...
    \begin{enumerate}
        \item $\displaystyle a_n=\dfrac{1}{\sqrt[r]{\ln n}}\,(r>0)$;
...
\begin{example}
    ...
    \begin{enumerate}
        \item $\displaystyle a_n=\dfrac{1}{\ln(n!)}\,(n\geq2)$;
        \item $\displaystyle a_n=\dfrac{\ln(n!)}{n^p}$;
        \item $\displaystyle a_n=\dfrac{\displaystyle\sum\limits_{k=1}^n\ln^2k}{n^p}$;
...
\begin{example}
    ...
    \begin{enumerate}
        \item 设 $a_n>0$,若 $\displaystyle\sum\limits_{n=1}^{\infty}a_n$ 收敛,则
              \[
                  \displaystyle\sum\limits_{n=1}^{\infty}\dfrac{\sqrt{a_n}}{n^p}
              \]
              在 $p>\dfrac{1}{2}$ 时收敛;
...
\begin{example}
    设 $a_n\neq0$,且 $a_n\to a\neq0$,则
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}|a_{n+1}-a_n|
    \]
    与
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}\left|\dfrac{1}{a_{n+1}}-\dfrac{1}{a_m}\right|
    \]
    同敛散.
\end{example}
\exampleblank
...
\begin{example}[\markstar\ Sapagof 判别法]
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}\left(1-\dfrac{a_{n+1}}{a_n}\right)
    \]
    发散.
\end{example}
\exampleblank
...
\begin{solution}
    ...
    正项无穷乘积的基本判别说明
    \[
        \displaystyle\prod\limits_{n=1}^{\infty}r_n>0
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 此处同样应为极限 $a_n/b_n\to0$.可取整数
              $1=N_1<N_2<\cdots$ 使
              \[
                  \displaystyle\sum\limits_{n=N_j}^{\infty}a_n<\dfrac{2^{-j}}{j},
              \]
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 可递归构造相邻区间 $I_k$ 与递减高度 $\alpha_k,\beta_k$:在奇数块令
              ...
              \[
                  \displaystyle\sum\limits_n\min\{a_n,b_n\}\leq\sum\limits_k2^{-k}<\infty.
              \]
...
\begin{example}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}\dfrac{1}{p_n}\text{ 收敛}
        \quad\Longleftrightarrow\quad
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\sum\limits_{n=1}^m A_n^p
        ...
        \item (Hardy-Landan 不等式)设 $p>1$,$\{a_n\}$ 同 (1),则
              \[
                  \displaystyle\sum\limits_{n=1}^m\left(\dfrac{a_1+a_2+\cdots+a_n}{n}\right)^p
                  <\left(\dfrac{p}{p-1}\right)^p\sum\limits_{n=1}^ma_n^p;
              \]
        \item (Cauleman 不等式)设 $\displaystyle\sum\limits_{n=1}^{\infty}a_n$ 是正项收敛级数,则
              \[
                  \displaystyle\sum\limits_{n=1}^{\infty}\sqrt[n]{a_1a_2\cdots a_n}
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 对 (1) 的右端使用 H\"older 不等式:
              \[
                  \displaystyle\sum\limits_{n=1}^{m}A_n^{p-1}a_n
                  \leq
        ...
        \item 在 (2) 中以 $a_n^{1/p}$ 代替 $a_n$,得到
              \[
                  \displaystyle\sum\limits_{n=1}^{m}
...
\begin{example}
    研究
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}\dfrac{1}{x_n^2}
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}a_n^{1-\frac{1}{n}}
    \]
    收敛.
\end{example}
\exampleblank
...
\begin{example}[\markstar]
    \begin{enumerate}
        ...
        \item 求证:当 $s>1$ 时,
              \[
                  \displaystyle\int_1^{+\infty}\dfrac{x-[x]}{x^{s+1}}\,\mathrm{d}x
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 记上述反常积分为 $I_n$.同一公式给出 $|I_n|\leq C/n$,其中 $C$ 与 $n$ 无关.因此
              \[
                  \displaystyle\sum\limits_{n=1}^{\infty}\dfrac{|I_n|}{n}
...
\begin{example}
    判别
    \[
        \displaystyle\sum\limits_{k=1}^{\infty}\left[e-\left(1+\dfrac{1}{1!}+\dfrac{1}{2!}+\cdots+\dfrac{1}{n!}\right)\right]
    \]
    的敛散性.
\end{example}
\exampleblank
...
\begin{theorem}
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{a_n}{b_n}=l,
    \]
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item $\displaystyle a_n=\left(1-\sqrt[3]{\dfrac{n-1}{n+1}}\right)^p\,(p>0)$;
...
\begin{example}
    判断级数 $\displaystyle I=\sum\limits_{n=1}^{\infty}a_n$ 的敛散性:
    \begin{enumerate}
        \item $\displaystyle a_n=\left(\dfrac{1}{n}-\sin\dfrac{1}{n}\right)^p\,(p>0)$;
        \item $\displaystyle a_n=\left(e^{\frac{1}{n}}-\sin\dfrac{1}{n}\right)^{np}-1$;
        \item $\displaystyle a_n=\ln\left(\dfrac{1}{\cos\dfrac{2\pi}{n}}\right)\,(n>4)$.
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{example}
    设正数列 $\{a_n\}$ 满足
    \[
        \displaystyle\lim\limits_{n\to\infty}a_n\sum\limits_{i=1}^na_i^2=1.
    \]
    试证明:
    \[
        \displaystyle\lim\limits_{n\to\infty}\sqrt[3]{3na_n}=1,
    \]
...
\begin{theorem}[\markstar\ Cauchy 凝聚判别法]
    设 $\{a_n\}$ 是递减正数列,则
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}a_n\text{ 收敛}
        \quad\Longleftrightarrow\quad
...
\begin{proposition}[\markstar]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}na_n=0.
    \]
\end{proposition}
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}na_n\ln n=0.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    ...
    对充分大的 $n$,
    \[
        \displaystyle\sum\limits_{k=\lceil\sqrt n\rceil}^{n}a_k
...
\begin{solution}
    ...
    \begin{enumerate}
        \item 在区间 $2^k\leq n<2^{k+1}$ 上,
              \[
                  \displaystyle\sum\limits_{n=2^k}^{2^{k+1}-1}\dfrac{a_n}{n}
...
\begin{remark}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}3^na_{3^n},
        \qquad
...
\begin{solution}
    ...
    \begin{enumerate}
        \item 交换非负项的求和次序,
              \[
                  \displaystyle\sum\limits_{n=1}^{\infty}R_n
        ...
        \item 由单调性,
              \[
                  \displaystyle\sum\limits_{k=\lceil n/2\rceil}^{n}\dfrac{a_k}{\sqrt k}
...
\begin{example}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}nb_n=a_1.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item $\displaystyle a_n=\dfrac{(\alpha+1)(2\alpha+1)\cdots(n\alpha+1)}{(\beta+1)(2\beta+1)\cdots(n\beta+1)}\,(\alpha>0,\beta>0)$;
        \item $\displaystyle a_n=\dfrac{n^\alpha}{\beta^n}\,(\beta>0)$.
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{example}[\markstar\ 比式判别法推广]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{a_{n+k_0}}{a_n}=\lambda,
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\left(\dfrac{a_{n+1}}{a_n}\right)^n=\lambda,
    \]
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item $\displaystyle a_n=\dfrac{\ln(1+\alpha^n)}{n^\beta}\,(\alpha\geq0)$.
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item
              \[
                  \displaystyle\limsup\sqrt[n]{a_n}
...
\begin{example}
    设 $\{a_n\},\{b_n\}$ 为正数列,若有
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{a_{n+1}}{a_n}=\alpha,
        \qquad
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item 设 $a_n>0$,$\displaystyle\sum\limits_{n=1}^{\infty}\dfrac{a_n}{n}$ 收敛,则
              \[
                  \displaystyle\sum\limits_{n=1}^{\infty}\left(\sum\limits_{k=1}^{\infty}\dfrac{a_n}{n^2+k^2}\right)
              \]
              收敛.
    \end{enumerate}
\end{example}
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 当前内层求和的分子为 $a_n$.利用积分比较,
              \[
                  \displaystyle\sum\limits_{k=1}^{\infty}\dfrac{1}{n^2+k^2}
...
\begin{solution}
    ...
    \[
        \displaystyle\sum\limits_{n=2}^{\infty}|f'(n)|
...
\begin{example}[比值对数判别法]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\left(n\ln\dfrac{a_n}{a_{n+1}}\right)=l,
...
\begin{example}[Rabbe 判别法]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}n\left(\dfrac{a_n}{a_{n+1}}-1\right)=l,
        \qquad -\infty\leq l\leq+\infty.
    \]
...
\begin{example}[\markstar\ Kummer 判别法]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\left(\dfrac{1}{b_n}\dfrac{a_n}{a_{n+1}}-\dfrac{1}{b_{n+1}}\right)=\lambda,
    \]
...
\begin{example}[对数判别法]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{\ln\dfrac{1}{a_n}}{\ln n}=l,
    \]
...
\begin{proposition}[\marktwostar\ Abel 变换]
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\sum\limits_{k=1}^na_kb_k
                  =a_nB_n+\sum\limits_{k=1}^{n-1}(a_k-a_{k+1})B_k;
              \]
        \item
              \[
                  \displaystyle\sum\limits_{k=n+1}^ma_kb_k
...
\begin{example}
    研究
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}\dfrac{(-1)^{n-1}}{n^{p+\frac{1}{n}}}
    \]
    的绝对收敛与条件收敛性.
\end{example}
\exampleblank
...
\begin{example}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}f\left(\dfrac{1}{n}\right)
    \]
    绝对收敛.
\end{example}
\exampleblank
...
\begin{example}
    讨论级数
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}\left(1+\dfrac{1}{2}+\dfrac{1}{3}+\cdots+\dfrac{1}{n}\right)\dfrac{\sin nx}{n}
    \]
    的敛散性.
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \[
        \displaystyle\sum\limits_{k=1}^{N}\sin(kx)
...
\begin{solution}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}a_nb_n=-\sum\limits_{n=1}^{\infty}\dfrac{1}{n}
    \]
...
\begin{corollary}[\markstar]
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}a_n^+=+\infty,
        \qquad
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{e^{A_n}-e^{A_{n-1}}}{A_n^e-A_{n-1}^e}.
    \]
\end{example}
\exampleblank
...
\begin{example}[\markstar]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{\displaystyle\sum\limits_{k=1}^nka_k}{n}=0.
    \]
\end{example}
\exampleblank
...
\begin{definition}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}a_n=\sigma(C).
    \]
    此时称级数可以 Cesaro 求和.
\end{definition}
...
\begin{remark}
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}(-1)^{n-1}=\dfrac{1}{2}(C).
    \]
\end{remark}
...
\begin{example}[\markstar\ 可以 Cesaro 求和的必要条件]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{S_n}{n}=0,
        \qquad
...
\begin{example}[\markstar]
    ...
    \[
        \displaystyle\sum\limits_{n=1}^{\infty}a_n\text{ 在通常意义下收敛}
        \quad\Longleftrightarrow\quad
...
\begin{solution}
    ...
    \[
        \displaystyle\sum\limits_{k=0}^{n}a_k=a_0+a_1+\cdots+a_n,
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\sum\limits_{n=0}^{\infty}\dfrac{(a+b)^n}{n!}.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \[
        \displaystyle\sum\limits_{k=0}^{n}\dfrac{a^k}{k!}\dfrac{b^{n-k}}{(n-k)!}
...
%例题8.4.13
\begin{example}
    求下列级数 $S=\displaystyle\sum c_n$ 的和:
    \begin{enumerate}
...
\begin{theorem}[\markstar]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}p_n=1.
    \]
\end{theorem}

\begin{theorem}[\markstar]
    \[
        \displaystyle\prod\limits_{n=1}^{\infty}(1+a_n)\text{ 收敛}
        \quad\Longleftrightarrow\quad
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 恒等式
              \[
                  \displaystyle\prod\limits_{n=0}^{N}(1+x^{2^n})=\dfrac{1-x^{2^{N+1}}}{1-x}
              \]
              在 $x=1/2$ 时给出极限 $2$.
    \end{enumerate}
\end{solution}
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 裂项相消得
              \[
                  \displaystyle\prod\limits_{n=1}^{N}\dfrac{(n+1)^2}{n(n+2)}
                  =\dfrac{2(N+1)}{N+2}\longrightarrow2,
              \]
              故收敛.
        \item 取对数后,
              \[
                  \displaystyle\sum\limits_{n=1}^{\infty}\dfrac{1}{n}\ln\left(1+\dfrac{1}{n}\right)
              \]
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item $\displaystyle\prod\limits_{n=2}^{\infty}\left(\dfrac{n^2-1}{n^2+1}\right)^p\,(p\in\mathbb{R})$.
    \end{enumerate}
\end{example}
\exampleblank
