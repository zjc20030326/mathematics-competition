...
\begin{enumerate}
    \item 当
          ...
          (称为 $x$ 型区域)时,
          \[
              \displaystyle\iint\limits_{D_1}f(x,y)\,\mathrm{d}x\,\mathrm{d}y
    ...
    \item 当
          ...
          (称为 $y$ 型区域)时,
          \[
              \displaystyle\iint\limits_{D_2}f(x,y)\,\mathrm{d}x\,\mathrm{d}y
...
\begin{solution}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\int_0^{\frac{a}{2}}\!\mathrm{d}x\int_{\frac{x}{2}}^{2x}f(x,y)\,\mathrm{d}y
                  +\int_{\frac{a}{2}}^{2a}\!\mathrm{d}x\int_{\frac{x}{2}}^{a}f(x,y)\,\mathrm{d}y.
              \]
        \item 令 $x_{\pm}(y)=\dfrac{-1\pm\sqrt{1+4y}}{2}$,则原积分等于
              \[
                  \displaystyle\int_{-\frac{1}{4}}^{0}\!\mathrm{d}y\int_{x_-(y)}^{x_+(y)}f(x,y)\,\mathrm{d}x
                  +\int_0^2\!\mathrm{d}y\int_{y-1}^{x_+(y)}f(x,y)\,\mathrm{d}x.
              \]
        \item
              \[
                  \displaystyle\int_{-a}^{0}\!\mathrm{d}x\int_{-x}^{a}f(x,y)\,\mathrm{d}y
                  +\int_0^{\sqrt[4]{a}}\!\mathrm{d}x\int_{x^4}^{a}f(x,y)\,\mathrm{d}y.
              \]
        \item 题面给出的上下限在靠近 $x=0$ 时次序相反.按有向积分拆成两个正常区域,原式为
              \[
                  \displaystyle\int_0^{8a^2}\!\mathrm{d}y\int_{\frac{y}{4a}}^{2a}f(x,y)\,\mathrm{d}x
...
\begin{solution}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\int_0^{2a}\!\mathrm{d}r\int_0^{\arccos\frac{r}{2a}}f(r,\theta)\,\mathrm{d}\theta.
              \]
        \item
              \[
                  \displaystyle\int_0^a\!\mathrm{d}r\int_0^{\frac{\pi}{4}}f(r,\theta)\,\mathrm{d}\theta
                  +\int_a^{\sqrt{2}a}\!\mathrm{d}r\int_{\arccos\frac{a}{r}}^{\frac{\pi}{4}}f(r,\theta)\,\mathrm{d}\theta.
              \]
        \item
              \[
                  \displaystyle\int_0^{2a}\!\mathrm{d}r
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\int_0^e\mathrm{d}y\int_1^{y^2}\dfrac{\ln x}{e^x}\,\mathrm{d}x
                  +\int_e^{e^2}\mathrm{d}y\int_{\ln y}^{2}\dfrac{\ln x}{e^x}\,\mathrm{d}x
                  =\int_1^2\ln x\,\mathrm{d}x;
              \]
        \item
              \[
                  \displaystyle\int_a^b\mathrm{d}y\int_a^y(y-x)^n f(x)\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_a^b f(x)\,\mathrm{d}x\int_x^b(y-x)^n\,\mathrm{d}y
        =\dfrac{1}{n+1}\int_a^b(b-x)^{n+1}f(x)\,\mathrm{d}x.
    \]
\end{solution}
...
\begin{solution}
    ...
    其中
    \[
        \displaystyle\int_{-1}^1x(1-x^3)\,\mathrm{d}x=-\dfrac{2}{5}.
    \]
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\iint\limits_D\left|xy-\dfrac{1}{4}\right|\,\mathrm{d}x\,\mathrm{d}y,
                  \qquad D=\lbrack0,1\rbrack\times\lbrack0,1\rbrack;
              \]
        \item
              \[
                  \displaystyle\iint\limits_{|x|\leq1,\ 0\leq y\leq2}\sqrt{|y-x^2|}\,\mathrm{d}x\,\mathrm{d}y.
              \]
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \begin{enumerate}
        \item 对 $x\leq\dfrac{1}{4}$ 不变号,对 $x>\dfrac{1}{4}$ 在 $y=\dfrac{1}{4x}$ 处分开,得到
              \[
                  \displaystyle\iint_D\left|xy-\dfrac{1}{4}\right|\,\mathrm{d}x\,\mathrm{d}y
...
\begin{solution}
    \begin{enumerate}
        ...
        \item 令 $s=x+y$.正方形中截线长度在 $0\leq s\leq2$ 时为 $s$,在 $2\leq s\leq4$ 时为 $4-s$,故
              \[
                  \displaystyle\int_0^2[s]s\,\mathrm{d}s+\int_2^4[s](4-s)\,\mathrm{d}s=6.
              \]
    \end{enumerate}
\end{solution}
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item 存在 $\lbrack0,1\rbrack\times\lbrack0,1\rbrack$ 上非负不可积函数 $f(x,y)$, 使得
              \[
                  \displaystyle\int_0^1\mathrm{d}x\int_0^1f(x,y)\,\mathrm{d}y
                  =0
...
\begin{solution}
    \begin{enumerate}
        \item 取 $D=\{(x,y)\mid0\leq x\leq1,\ 0<y\leq1\}$ 及
              ...
              它在 $D$ 上连续,并且
              \[
                  \displaystyle\int_0^1\!\mathrm{d}x\int_0^1f(x,y)\,\mathrm{d}y=\dfrac{1}{8},
                  \qquad
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\iint\limits_D\dfrac{x^2-y^2}{\sqrt{x+y+3}}\,\mathrm{d}x\,\mathrm{d}y,
                  \qquad D=\{(x,y)\mid |x|+|y|\leq1\};
              \]
        \item
              \[
                  \displaystyle\iint\limits_D\dfrac{(x+y)\ln(1+xy)}{\sqrt{1-x-y}}\,\mathrm{d}x\,\mathrm{d}y,
                  \qquad D=\left\{(x,y)\mid0\leq y\leq x,\ \dfrac{3}{4}\leq x+y\leq1\right\};
              \]
        \item
              \[
                  \displaystyle\iint\limits_De^{\frac{x-y}{x+y}}\,\mathrm{d}x\,\mathrm{d}y,
              \]
...
\begin{solution}
    \begin{enumerate}
        ...
        \item 令 $u=x+y$,$v=x-y$,则 $\dfrac{3}{4}\leq u\leq1$,$0\leq v\leq u$,$\mathrm{d}x\,\mathrm{d}y=\dfrac{1}{2}\mathrm{d}u\,\mathrm{d}v$.先积去 $v$ 后得到精确的一维表示
              \[
                  \displaystyle\int_{\frac{3}{4}}^{1}\dfrac{u}{\sqrt{1-u}}
        ...
        \item 令 $u=x+y$,$v=(x-y)/(x+y)$,则 $0\leq u\leq1$,$-1\leq v\leq1$,Jacobian 为 $u/2$.故
              \[
                  \displaystyle\iint_D e^{\frac{x-y}{x+y}}\,\mathrm{d}x\,\mathrm{d}y
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item
              \[
                  \displaystyle\iint\limits_D\dfrac{1}{xy}\,\mathrm{d}x\,\mathrm{d}y,
              \]
              其中 $D$ 为平面上由
              \[
        ...
        \item
              \[
                  \displaystyle\iint\limits_D\left(3x^3+x^2+y^2+2x-2y+1\right)\,\mathrm{d}x\,\mathrm{d}y,
              \]
              其中
              \[
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\iint\limits_{x^2+y^2\leq\frac{3}{16}}
                  \min\left\{\sqrt[3]{\dfrac{3}{16}-x^2-y^2},\ 2(x^2+y^2)\right\}\,\mathrm{d}x\,\mathrm{d}y;
              \]
        \item
              \[
                  \displaystyle\iint\limits_{x^2+y^2\leq1}\left|\dfrac{x+y}{\sqrt{2}}-x^2-y^2\right|\,\mathrm{d}x\,\mathrm{d}y.
              \]
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{solution}
    \begin{enumerate}
        ...
        \item 旋转坐标后,被积函数为 $|r\cos\theta-r^2|$.对角变量先积分,有
              \[
                  \displaystyle\int_0^{2\pi}|\cos\theta-r|\,\mathrm{d}\theta
...
\begin{solution}
    \begin{enumerate}
        ...
        \item 由四象限对称性和 Dirichlet 积分,
              \[
                  \displaystyle\iint_{x^4+y^4\leq1}(x^2+y^2)\,\mathrm{d}x\,\mathrm{d}y
...
\begin{example}
    计算积分
    \[
        \displaystyle\iint\limits_D\sqrt{\dfrac{xy}{x+y}}\,\mathrm{d}x\,\mathrm{d}y,
    \]
...
\begin{theorem}[\markstar]
    ...
    \[
        \displaystyle\iint\limits_Df(x,y)\,\mathrm{d}x\,\mathrm{d}y=f(\xi,\eta)|D|.
    \]
    其中 $|D|$ 表示 $D$ 的面积.
\end{theorem}
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\iint\limits_D f_{xy}(x,y)\,\mathrm{d}x\,\mathrm{d}y
...
\begin{solution}
    由微积分基本定理,
    \[
        \displaystyle\iint_Df_{xy}\,\mathrm{d}x\,\mathrm{d}y
    ...
    \[
        \displaystyle\iint_{[x,x+h]\times[y,y+k]}(f_{xy}-f_{yx})\,\mathrm{d}x\,\mathrm{d}y=0.
    \]
...
\begin{example}
    ...
    试证
    \[
        \displaystyle\iint\limits_D\left[\left(\dfrac{\partial f}{\partial x}\right)^2+
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^1g(x)\,\mathrm{d}x=-\dfrac{1}{2}\int_0^1x(1-x)g''(x)\,\mathrm{d}x.
    \]
    分别对 $x,y$ 使用此式,得到
    \[
        \displaystyle\iint_Df=\dfrac{1}{4}\iint_Dx(1-x)y(1-y)f_{xxyy}(x,y)\,\mathrm{d}x\,\mathrm{d}y.
    \]
    因此
    \[
...
\begin{example}[\markstar]
    用二重积分计算
    \[
        \displaystyle\int_0^{+\infty}e^{-x^2}\,\mathrm{d}x.
    \]
\end{example}
\exampleblank

\begin{solution}
    令 $I=\displaystyle\int_0^{+\infty}e^{-x^2}\,\mathrm{d}x$.由 Tonelli 定理与极坐标变换,
    \[
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\iiint\limits_V\dfrac{z\ln(x^2+y^2+z^2+1)}{x^2+y^2+z^2+1}\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
              \]
              其中 $V:x^2+y^2+z^2\leq1$;
        \item
              \[
                  \displaystyle\iiint\limits_{\substack{x^2+y^2+z^2\leq1\\x^2+y^2-z^2\geq\frac{1}{2}}}z\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z.
              \]
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{example}
    求积分
    \[
        \displaystyle\iiint\limits_V(x+y+z)\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
    \]
...
\begin{solution}
    ...
    \[
        \displaystyle\iiint_V(x+y+z)\,\mathrm{d}V
...
\begin{example}
    ...
    \[
        \displaystyle\iiint\limits_\Omega x^2y^2z\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z.
    \]
\end{example}
\exampleblank
...
\begin{example}
    计算积分
    \[
        \displaystyle\iiint\limits_V\dfrac{\mathrm{d}V}{y^2+z^2},
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\iiint\limits_V y\cos(x+z)\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\iiint\limits_V(xy+yz+zx)\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
    \]
...
\begin{theorem}[\markstar]
    ...
    \[
        \displaystyle\iiint\limits_\Omega f(x,y,z)\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z
...
\begin{example}
    \begin{enumerate}
        \item 证明
              \[
                  \displaystyle\iint\limits_S f(ax+by)\,\mathrm{d}x\,\mathrm{d}y
                  =2\int_{-1}^1\sqrt{1-u^2}\,f\left(u\sqrt{a^2+b^2}\right)\mathrm{d}u,
              \]
              其中 $S:x^2+y^2\leq1,a^2+b^2\ne0$;
        \item 证明
              \[
                  \displaystyle\iiint\limits_Vf(ax+by+cz)\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z
...
\begin{solution}
    ...
    \[
        \displaystyle\iint_Sf(ax+by)\,\mathrm{d}x\,\mathrm{d}y
        =2\int_{-1}^1\sqrt{1-u^2}\,f\left(u\sqrt{a^2+b^2}\right)\mathrm{d}u.
    \]
...
\begin{example}
    计算积分
    \[
        \displaystyle\iiint\limits_\Omega x^2\sqrt{x^2+y^2}\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
    \]
...
\begin{example}
    计算积分
    \[
        \displaystyle\iiint\limits_\Omega z^2\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
    \]
...
\begin{example}
    计算积分
    \[
        \displaystyle\iiint\limits_{x^2+y^2+z^2\leq1}\cos(ax+by+cz)\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item
              \[
                  \displaystyle\iiint\limits_V\dfrac{xyz}{x^2+y^2}\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
              \]
              其中 $V$ 是曲面 $(x^2+y^2+z^2)^2=a^2xy$ $(a>0)$ 位于第一象限所围立体;
        \item
              \[
                  \displaystyle\iiint\limits_V(x+y+z)^2\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
              \]
...
\begin{example}[\markstar]
    \begin{enumerate}
        \item 设 $a,b,c>0$, 证明
              \[
                  \displaystyle\iiint\limits_Vx^{a-1}y^{b-1}z^{c-1}\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z
                  =\dfrac{1}{a+b+c}\dfrac{\Gamma(a)\Gamma(b)\Gamma(c)}{\Gamma(a+b+c)},
              \]
              其中 $V$ 为四面体 $x\geq0,y\geq0,z\geq0,x+y+z\leq1$;
        \item 计算
              \[
                  \displaystyle\iiint\limits_Vxy^9z^8w^4\,\mathrm{d}x\,\mathrm{d}y\,\mathrm{d}z,
                  \qquad w=1-x-y-z,
              \]
...
\begin{solution}
    \begin{enumerate}
        \item 逐次使用 Beta 积分即得
              \[
                  \displaystyle\iiint_Vx^{a-1}y^{b-1}z^{c-1}\,\mathrm{d}V
                  =\dfrac{\Gamma(a)\Gamma(b)\Gamma(c)}{\Gamma(a+b+c+1)}
                  =\dfrac{1}{a+b+c}\dfrac{\Gamma(a)\Gamma(b)\Gamma(c)}{\Gamma(a+b+c)}.
              \]
        \item 把 $w=1-x-y-z$ 看作第四个单纯形坐标,Dirichlet 积分给出
              \[
                  \displaystyle\iiint_Vxy^9z^8w^4\,\mathrm{d}V
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{t\to0^+}\dfrac{1}{\pi t^4}
...
\begin{example}[\markstar]
    证明
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{1}{n^4}
...
\begin{solution}
    反复使用一维恒等式
    \[
        \displaystyle\int_0^1g(t)\,\mathrm{d}t=-\dfrac{1}{2}\int_0^1t(1-t)g''(t)\,\mathrm{d}t
    \]
    (其中 $g(0)=g(1)=0$),得到
    \[
        \displaystyle\iiint_Vf=-\dfrac{1}{8}\iiint_Vx(1-x)y(1-y)z(1-z)f_{xxyyzz}\,\mathrm{d}V.
    \]
    取绝对值并用 $\displaystyle\int_0^1t(1-t)\,\mathrm{d}t=1/6$,即得
    \[
...
\begin{example}[\markstar]
    设
    \[
        \displaystyle\sum\limits_{i,j=1}^3a_{ij}x_ix_j
    \]
...
\begin{theorem}[\markstar\ 化为累次积分]
    \begin{enumerate}
        \item 设
              ...
              $f$ 在 $V$ 上连续, 则
              \[
                  \displaystyle\int\cdots\int\limits_V f(x_1,\ldots,x_n)\,\mathrm{d}x_1\cdots\mathrm{d}x_n
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^1r^3\sqrt{\dfrac{1-r^2}{1+r^2}}\,\mathrm{d}r
...
\begin{example}
    ...
    \[
        \displaystyle\int_a^x\mathrm{d}x_1\int_a^{x_1}\mathrm{d}x_2\cdots\int_a^{x_n}f(x_{n+1})\,\mathrm{d}x_{n+1}
...
\begin{example}
    ...
    \[
        \displaystyle\int_0^1f(x)\,\mathrm{d}x=A,
    \]
    求积分
    \[
        \displaystyle\int_0^1\cdots\int_0^1
...
\begin{solution}
    ...
    \[
        \displaystyle\sum_{j=1}^nI_j=\int_{[0,1]^n}\prod_{j=1}^nf(x_j)\,\mathrm{d}x_1\cdots\mathrm{d}x_n=A^n.
    \]
    所以原积分为
    \[
...
\begin{theorem}[\markstar]
    ...
    \[
        \displaystyle\iint\limits_D f(x,y)\,\mathrm{d}x\,\mathrm{d}y\text{ 收敛}
        \iff
        \left\{\iint\limits_{D_n}f(x,y)\,\mathrm{d}x\,\mathrm{d}y\right\}\text{ 有界}
    \]
    且等价于
    \[
        \displaystyle\lim\limits_{n\to+\infty}\iint\limits_{D_n}f(x,y)\,\mathrm{d}x\,\mathrm{d}y
    \]
    存在.
\end{theorem}
...
\begin{solution}
    ...
    \[
        \displaystyle\iint_{D_R}\sin(x^2+y^2)\,\mathrm{d}x\,\mathrm{d}y
...
\begin{solution}
    \begin{enumerate}
        \item 由 $m\leq|\varphi|\leq M$,绝对收敛性等价于
              \[
                  \displaystyle\int_1^{+\infty}r^{1-2p}\,\mathrm{d}r<+\infty,
              \]
        ...
        \item 若按通常意图补充 $x,y\geq0$,令 $u=x+y$,则内层积分为
              \[
                  \displaystyle\int_0^u\sin x\sin(u-x)\,\mathrm{d}x=\dfrac{1}{2}(\sin u-u\cos u).
              \]
...
\begin{example}
    ...
    则
    \[
        \displaystyle\iint\limits_D|f(x,y)|^p\,\mathrm{d}x\,\mathrm{d}y\text{ 收敛}
        \iff1\leq p\leq2.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    ...
    因此局部可积性等价于
    \[
        \displaystyle\int_0^\varepsilon\!\int_0^\varepsilon(u+v)^{-p}\,\mathrm{d}u\,\mathrm{d}v<+\infty,
    \]
    其充要条件为 $p<2$.所以在题设 $p\geq1$ 下,正确结论是
    \[
        \displaystyle\iint_D|f|^p<+\infty\iff1\leq p<2.
    \]
...
\begin{solution}
    ...
    \[
        \displaystyle\int_1^{+\infty}t^{s-2}\,\mathrm{d}t
    \]
