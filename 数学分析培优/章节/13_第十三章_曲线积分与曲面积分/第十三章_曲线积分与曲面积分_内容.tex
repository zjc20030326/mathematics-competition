% !TEX root = 第十三章_曲线积分与曲面积分(答案版).tex
...
\begin{theorem}[\markstar\ 计算公式]
    ...
    \[
        \displaystyle\int\limits_L f(P)\,\mathrm{d}s
...
\begin{solution}
    ...
    \[
        \displaystyle\int_Lx^2\,\mathrm{d}s=\dfrac{1}{3}\int_L(x^2+y^2+z^2)\,\mathrm{d}s=\dfrac{2\pi a^3}{3}.
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_L(x+y)\,\mathrm{d}s,
    \]
...
\begin{example}
    求曲线积分
    \[
        \displaystyle\int\limits_C e^{-(x^2+y^2)}\left\lbrack \cos(2xy)\,\mathrm{d}x+\sin(2xy)\,\mathrm{d}y\right\rbrack,
    \]
...
\begin{example}
    计算积分
    \[
        \displaystyle\int\limits_{ABC}\dfrac{\mathrm{d}x+\mathrm{d}y}{|x|+|y|},
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_L y\,\mathrm{d}x+z\,\mathrm{d}y+x\,\mathrm{d}z,
    \]
    其中
    \[
...
\begin{solution}
    ...
    代入并逐项积分,得到
    \[
        \displaystyle\int_Ly\,\mathrm{d}x+z\,\mathrm{d}y+x\,\mathrm{d}z
...
\begin{example}
    计算第一型曲线积分
    \[
        \displaystyle\int\limits_C\left(
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_{\widehat{OA}}(x^2+y^2)\,\mathrm{d}x+4xy\,\mathrm{d}y,
    \]
    其中:
    \begin{enumerate}
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 在线段 $OA$ 上 $y=0$,故积分为 $\displaystyle\int_0^ax^2\,\mathrm{d}x=a^3/3$.
    \end{enumerate}
\end{solution}
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_{L^+}x\,\mathrm{d}y-y\,\mathrm{d}x,
    \]
    其中
    \[
...
\begin{theorem}[\markstar\ Green 公式]
    ...
    \[
        \displaystyle\int\limits_{\partial\Omega}P\,\mathrm{d}x+Q\,\mathrm{d}y
...
\begin{solution}
    用 Green 公式.
    \begin{enumerate}
        \item 面积分为 $\displaystyle\iint_{x^2+y^2\leq a^2}(x^2+y^2)\,\mathrm{d}x\,\mathrm{d}y=\pi a^4/2$.
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_C\dfrac{e^y}{x^2+y^2}
...
\begin{solution}
    ...
    \]
    它是 $-\operatorname{Re}\displaystyle\int_0^{2\pi}e^{i e^{-it}}\,\mathrm{d}t=-2\pi$.
\end{solution}
...
\begin{example}
    设 $C$ 为对称于坐标轴的光滑曲线, 证明
    \[
        \displaystyle\int\limits_C(x^3y+e^y)\,\mathrm{d}x+(xy^3+xe^y-\cos x)\,\mathrm{d}y=0.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    由 Green 公式,积分等于
    \[
        \displaystyle\iint_D(y^3-x^3+\sin x)\,\mathrm{d}x\,\mathrm{d}y.
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\int\limits_{\partial D}\dfrac{F(xy)}{y}\,\mathrm{d}y
...
\begin{solution}
    Green 公式给出左端为 $\displaystyle\iint_Df(xy)\,\mathrm{d}x\,\mathrm{d}y$.令 $u=xy,v=y/x$,则 $1\leq u,v\leq4$,Jacobian 为 $1/(2v)$,所以
    \[
        \displaystyle\iint_Df(xy)\,\mathrm{d}x\,\mathrm{d}y
...
\begin{example}
    ...
    \[
        \displaystyle\int\limits_L\dfrac{\partial u}{\partial\bm n}\,\mathrm{d}s
...
\begin{solution}
    ...
    \[
        \displaystyle\int_Lu_{\bm n}\,\mathrm{d}s=\int_Lu_x\,\mathrm{d}y-u_y\,\mathrm{d}x
...
\begin{solution}
    取单位圆正向一周并令被积函数为 $-y\,\mathrm{d}x$.此时 $\displaystyle\int_C\mathrm{d}x=0$,但 $\displaystyle\int_C-y\,\mathrm{d}x=\pi$,不可能写成某个函数中值乘以 $\displaystyle\int_C\mathrm{d}x$.
\end{solution}
...
\begin{example}
    证明
    \[
        \displaystyle\int\limits_L\cos(\bm l,\bm n)\,\mathrm{d}s=0,
    \]
...
\begin{example}
    计算 Gauss 积分
    \[
        \displaystyle\int\limits_L\dfrac{\cos(\bm r,\bm n)}{r}\,\mathrm{d}s,
    \]
...
\begin{example}[\markstar]
    ...
    \[
        \displaystyle\int\limits_C\bm F\cdot\bm n\,\mathrm{d}s=0,
    \]
...
\begin{example}[\markstar]
    ...
    \[
        \displaystyle\int\limits_C P(x,y)\,\mathrm{d}x+Q(x,y)\,\mathrm{d}y=0,
    \]
    证明
    \[
        P(x,y)\equiv0,
...
\begin{solution}
    ...
    题面所写 $Q_y\equiv0$ 不成立.例如 $P=0,Q=y$ 时任意上半圆弧上 $\displaystyle\int Q\,\mathrm{d}y=\frac{1}{2}[y^2]_{y_0}^{y_0}=0$,但 $Q_y=1$.因此原结论应核对,按现有题面正确条件是 $P\equiv0,Q_x\equiv0$.
\end{solution}
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_{x^2+y^2=R^2}\ln\sqrt{(x-a)^2+(y-b)^2}\,\mathrm{d}s.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \[
        \displaystyle\int_{x^2+y^2=R^2}\ln\sqrt{(x-a)^2+(y-b)^2}\,\mathrm{d}s
        =2\pi R\ln\max\{R,\rho\}.
    \]
...
\begin{theorem}[\markstar]
    ...
    \[
        \displaystyle\iint\limits_D\Delta u\,\mathrm{d}x\,\mathrm{d}y
        =\int\limits_{\partial D}\dfrac{\partial u}{\partial\bm n}\,\mathrm{d}s,
    \]
    \[
        \displaystyle\iint\limits_Dv\Delta u\,\mathrm{d}x\,\mathrm{d}y
        =-\iint\limits_D\left(
    ...
    以及 Green 第二公式
    \[
        \displaystyle\iint\limits_D(v\Delta u-u\Delta v)\,\mathrm{d}x\,\mathrm{d}y
...
\begin{example}
    ...
    \[
        \displaystyle\int\limits_L\dfrac{\partial\ln r}{\partial\bm n}\,\mathrm{d}s,
    \]
    其中 $r$ 表示 $L$ 上动点到原点的距离.
\end{example}
\exampleblank
...
\begin{example}
    ...
    \[
        \displaystyle\iint\limits_\Omega u\left(\dfrac{\partial^2u}{\partial x^2}+\dfrac{\partial^2u}{\partial y^2}\right)\,\mathrm{d}x\,\mathrm{d}y<0.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    Green 第一恒等式给出
    \[
        \displaystyle\iint_\Omega u\Delta u\,\mathrm{d}A
...
\begin{example}
    ...
    \[
        \displaystyle\int\limits_C\dfrac{\partial u}{\partial\bm n}\,\mathrm{d}s=0,
    \]
    其中 $\bm n$ 为外法线方向.
\end{example}
\exampleblank
...
\begin{example}
    ...
    \[
        \displaystyle\iint\limits_Sf(x,y,z)\,\mathrm{d}S=0,
    \]
    证明 $\Delta f=0$.
\end{example}
\exampleblank
...
\begin{example}
    ...
    \[
        \displaystyle\iint\limits_\Sigma f(x,y,z)(x\,\mathrm{d}y\,\mathrm{d}z+y\,\mathrm{d}z\,\mathrm{d}x+z\,\mathrm{d}x\,\mathrm{d}y)=0
    \]
    的充要条件.
\end{example}
\exampleblank
...
\begin{solution}
    由 Gauss 公式,题给积分等于
    \[
        \displaystyle\iiint_\Omega\left(xf_x+yf_y+zf_z+3f\right)\,\mathrm{d}V.
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_{\widehat{AB}}(x^2+2xy-y^2)\,\mathrm{d}x+(x^2-2xy-y^2)\,\mathrm{d}y,
    \]
...
\begin{example}
    求
    \[
        \displaystyle\int\limits_L[ e^x\sin y-3(x+y)]\,\mathrm{d}x+(e^x\cos y-ax)\,\mathrm{d}y,
        \qquad a>0,
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_Lx\ln(x^2+y^2-1)\,\mathrm{d}x+y\ln(x^2+y^2-1)\,\mathrm{d}y,
    \]
...
\begin{theorem}[\markstar]
    ...
    \begin{enumerate}
        \item 设 $S:z=z(x,y)$, $\Delta$ 为 $S$ 在 $xOy$ 平面的投影, 则
              \[
                  \displaystyle\iint\limits_S f(x,y,z)\,\mathrm{d}S
        ...
        \item 设
              ...
              则
              \[
                  \displaystyle\iint\limits_Sf(x,y,z)\,\mathrm{d}S
...
\begin{example}
    计算
    \[
        \displaystyle\iint\limits_S|z|\,\mathrm{d}S,
    \]
...
\begin{solution}
    ...
    \[
        \displaystyle\iint_S|z|\,\mathrm{d}S=\dfrac{\pi a^3}{2}.
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\iint\limits_Sz\,\mathrm{d}S,
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\iint\limits_\Sigma\dfrac{\mathrm{d}S}{\sqrt{x^2+y^2+(z+a)^2}},
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\iint\limits_S(x^2+y^2)^\beta\,\mathrm{d}S,
        \qquad \beta>-1.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    \[
        \displaystyle\int_0^{2\pi}\int_0^\pi
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^{2\pi}\!\mathrm{d}\theta\int_0^\pi f(k\cos\varphi)\sin\varphi\,\mathrm{d}\varphi
        =2\pi\int_{-1}^1f(kz)\,\mathrm{d}z.
    \]
\end{solution}
...
\begin{solution}
    由上一题及旋转不变性,左端绝对值不超过 $2\pi\displaystyle\int_{-1}^1|f(t)|\,\mathrm{d}t$.端点为零及中值定理给出 $|f(t)|\leq M(1-|t|)$,而其积分为 $M$,故所求不超过 $2\pi M$.
\end{solution}
...
\begin{solution}
    ...
    因此
    \[
        \displaystyle\iint_S\rho\,\mathrm{d}S=4\pi abc,
    \]
    \[
        \displaystyle\iint_S\dfrac{1}{\rho}\,\mathrm{d}S
...
\begin{theorem}[\markstar]
    \[
        \displaystyle\iint\limits_{S^+}P\,\mathrm{d}y\,\mathrm{d}z+Q\,\mathrm{d}z\,\mathrm{d}x+R\,\mathrm{d}x\,\mathrm{d}y
...
\begin{example}
    ...
    取上侧, 计算
    \[
        \displaystyle\iint\limits_{S^+}x^2\,\mathrm{d}y\,\mathrm{d}z+y^2\,\mathrm{d}z\,\mathrm{d}x+(x-a)y z\,\mathrm{d}x\,\mathrm{d}y.
    \]
\end{example}
\exampleblank
...
\begin{example}
    求
    \[
        \displaystyle\iint\limits_Sz^2\cos\gamma\,\mathrm{d}S,
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\iint\limits_S\cos(\bm n,\bm l)\,\mathrm{d}S=0.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    计算
    \[
        \displaystyle\iint\limits_\Sigma f\left(\sqrt{x^2+y^2+z^2}\right)\cos(\bm r,\bm n)\,\mathrm{d}S.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \[
        \displaystyle\iiint_V\left(f'(r)+\dfrac{2f(r)}{r}\right)\mathrm{d}V,
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\iint\limits_S\dfrac{\cos(\bm n,\bm r)}{r^2}\,\mathrm{d}S,
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\iint\limits_{S_{\text{外}}}\dfrac{x\,\mathrm{d}y\,\mathrm{d}z+y\,\mathrm{d}z\,\mathrm{d}x+z\,\mathrm{d}x\,\mathrm{d}y}{(x^2+y^2+z^2)^{\frac{3}{2}}},
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\iint\limits_S\left\lbrack P\cos(\bm n,x)+Q\cos(\bm n,y)+R\cos(\bm n,z)\right\rbrack\,\mathrm{d}S=0
    \]
    当且仅当
    \[
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_{L^+}(z-y)\,\mathrm{d}x+(x-z)\,\mathrm{d}y+(y-x)\,\mathrm{d}z,
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_{L^+}(y^2+z^2)\,\mathrm{d}x+(x^2+z^2)\,\mathrm{d}y+(x^2+y^2)\,\mathrm{d}z,
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_{L^+}y\,\mathrm{d}x+z\,\mathrm{d}y+x\,\mathrm{d}z,
    \]
...
\begin{example}
    计算
    \[
        \displaystyle\int\limits_{L^+}(x^2-yz)\,\mathrm{d}x+(y^2-xz)\,\mathrm{d}y+(z^2-xy)\,\mathrm{d}z,
    \]
...
\begin{remark}
    ...
    \[
        \displaystyle\iint\limits_S\bm A\cdot\mathrm{d}\bm S
        =\iiint\limits_V\operatorname{div}\bm A\,\mathrm{d}V,
    \]
    \[
        \displaystyle\int\limits_L\bm A\cdot\mathrm{d}\bm r
...
\begin{definition}
    ...
    \[
        \displaystyle\int\limits_\Gamma\bm F\cdot\mathrm{d}\bm r=0,
    \]
    则称 $\bm F$ 为 $D$ 上的保守场.
\end{definition}
