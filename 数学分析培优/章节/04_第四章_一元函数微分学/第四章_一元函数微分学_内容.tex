...
\begin{solution}
    ...
    特别地,$f''(0)=0$.但
    \[
        \displaystyle\lim\limits_{h\to0^+}\dfrac{f''(h)-f''(0)}{h}=6,
        \qquad
...
\begin{solution}
    可导必连续.由左右极限
    \[
        \displaystyle\lim\limits_{x\to0^-}x^2\sin\dfrac{\pi}{x}=0,
        \qquad
        \lim\limits_{x\to0^+}(ax^2+b)=b,
    \]
    可知连续性要求且只要求 $A=b=0$.此时
    \[
        \displaystyle\lim\limits_{x\to0^-}\dfrac{f(x)-f(0)}{x}
...
\begin{solution}
    ...
    对任意正整数 $m$,都有
    \[
        \displaystyle\lim\limits_{x\to0}|x|^{-m}e^{-\frac{1}{x^2}}=0.
    \]
    因而若已知 $f^{(n)}(0)=0$,则
    \[
        f^{(n+1)}(0)
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 由
              \[
                  \displaystyle\sum\limits_{k=1}^{n}kx^k
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{n\to+\infty}f'(x_n)=0.
    \]
\end{example}
\exampleblank
...
\begin{example}
    \begin{enumerate}
        \item 设 $f(x)$ 在 $(a,b)$ 上可导,且有 $x_i\in(a,b),\lambda_i>0\,(i=1,2,\ldots,n)$,
              \[
                  \displaystyle\sum\limits_{i=1}^n\lambda_i=1,
              \]
              则存在 $\xi\in(a,b)$,使得
              \[
                  \displaystyle\sum\limits_{i=1}^n\lambda_i f'(x_i)=f'(\xi);
              \]
        \item 设 $f(x)$ 在 $(a,b)$ 上可导,且有 $x_i<y_i$,$x_i,y_i\in(a,b)\,(i=1,2,\ldots,n)$,则存在 $\xi\in(a,b)$,使得
              \[
                  \displaystyle\sum\limits_{i=1}^n[f(y_i)-f(x_i)]
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{t\to0}\dfrac{f(x+t)-f(x-t)}{t}
    \]
...
\begin{solution}
    ...
    \[
        H(x)=(1-x)^2f'(x).
    \]
    则 $H(c)=0$,且 $\displaystyle\lim\limits_{x\to1^-}H(x)=0$.将 $H$ 连续补定义到 $x=1$ 后,再用 Rolle 定理,存在 $\xi\in(c,1)$ 使
    \[
        0=H'(\xi)
...
\begin{solution}
    ...
    \[
        \displaystyle\int_a^b g(x)\,\mathrm{d}x=f(b)-f(a),
    \]
    存在 $\xi\in(a,b)$ 使
    \[
        \dfrac{b-a}{2}[g(a)+g(b)]
...
\begin{example}
    ...
    \[
        \displaystyle\sum\limits_{i=1}^n\dfrac{k_i}{f'(x_i)}
...
\begin{solution}
    ...
    \[
        \displaystyle\sum\limits_{i=1}^{n}\dfrac{k_i}{r_i}
        =\sum\limits_{i=1}^{n}k_i.
    \]
...
\begin{example}[\markstar]
    ...
    \[
        \displaystyle\lim\limits_{x\to+\infty}f(x)=A,
        \qquad
...
\begin{example}[\markstar]
    ...
    \begin{enumerate}
        \item 设 $f(x)$ 在 $(0,+\infty)$ 上可导,$a>0$,若
              \[
                  \displaystyle\lim\limits_{x\to+\infty}[af(x)+f'(x)]=l,
              \]
              则
              \[
                  \displaystyle\lim\limits_{x\to+\infty}f(x)=\dfrac{l}{a};
              \]
        \item 设 $f(x)$ 在 $(0,+\infty)$ 上可导,$a>0$,若有
              \[
                  \displaystyle\lim\limits_{x\to+\infty}[af(x)+2\sqrt{x}f'(x)]=l,
              \]
              则
              \[
                  \displaystyle\lim\limits_{x\to+\infty}f(x)=\dfrac{l}{a};
        ...
        \item 设 $f(x)$ 在 $(0,+\infty)$ 上二次可导,若有
              \[
                  \displaystyle\lim\limits_{x\to+\infty}[f(x)+f'(x)+f''(x)]=l,
              \]
              则
              \[
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{x\to+\infty}[f(x+A)-f(x)]=lA.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    且
    \[
        \displaystyle\lim\limits_{x\to0^+}\theta(x)=\dfrac{1}{4},
        \qquad
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{h\to0}\theta=\dfrac{1}{n+2}.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    证明:
    \[
        \displaystyle\lim\limits_{h\to0}\theta
        =\sqrt[n-1]{\dfrac{1}{n}}.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    其中 $\theta\in(0,1)$,并且
    \[
        \displaystyle\lim\limits_{h\to0}\theta=\dfrac{1}{2}.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \begin{enumerate}
        \item 因 $x^s$ 在 $\lbrack0,+\infty)$ 上严格递增,
              \[
                  \displaystyle\int_0^n x^s\,\mathrm{d}x
...
\begin{example}[\markstar]
    ...
    \begin{enumerate}
        ...
        \item (Holder 不等式)设 $a_i,b_i>0$,$0<p,q<1$,且 $\dfrac{1}{p}+\dfrac{1}{q}=1$,则
              \[
                  \displaystyle\sum\limits_{i=1}^n a_i b_i
                  \leq
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 此处同样应为 $p,q>1$.令
              ...
              \[
                  \displaystyle\sum\limits_{i=1}^{n}\dfrac{a_i}{A}\dfrac{b_i}{B}
