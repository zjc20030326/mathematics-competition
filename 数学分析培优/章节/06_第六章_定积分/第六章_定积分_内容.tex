...
\begin{solution}
    使用公式
    \[
        \displaystyle\int_0^{\frac{\pi}{2}}\sin^m x\cos^n x\,\mathrm{d}x
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 四个象限贡献相同,因此
              \[
                  \displaystyle\int_0^{2\pi}\sin^2x\cos^4x\,\mathrm{d}x
...
\begin{solution}
    ...
    \begin{enumerate}
        \item 由周期性及
              ...
              得
              \[
                  \displaystyle\int_{-\pi}^{\pi}\cos^4x\sin^4x\,\mathrm{d}x
                  =\boxed{\dfrac{3\pi}{64}}.
              \]
        ...
        \item 关于 $\dfrac{\pi}{2}$ 对称,故
              \[
                  \displaystyle\int_0^\pi|\cos^5x|\,\mathrm{d}x
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item $\displaystyle\int_0^{2\pi}\dfrac{\mathrm{d}x}{1+a\cos x}\,(-1<a<1)$.
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 使用 $t=\tan\dfrac{x}{2}$,并把 $0$ 到 $2\pi$ 分成两段,可得标准积分
              \[
                  \displaystyle\int_0^{2\pi}\dfrac{\mathrm{d}x}{1+a\cos x}
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\int_1^a f\left(x^2+\dfrac{a^2}{x^2}\right)\dfrac{\mathrm{d}x}{x}
                  =\int_1^a f\left(x+\dfrac{a^2}{x}\right)\dfrac{\mathrm{d}x}{x};
              \]
        \item
              \[
                  \displaystyle\int_0^{2\pi}f(a\cos x+b\sin x)\,\mathrm{d}x
...
\begin{solution}
    ...
    \begin{enumerate}
        \item 左端令 $t=x^2$,得
              ...
              \[
                  \displaystyle\int_1^a f\left(u+\dfrac{a^2}{u}\right)\dfrac{\mathrm{d}u}{u}.
              \]
        ...
        \item 取 $R=\sqrt{a^2+b^2}$ 及角 $\varphi$,使
              ...
              \[
                  \displaystyle\int_0^{2\pi}f(R\cos x)\,\mathrm{d}x.
              \]
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{1}{n}
...
\begin{example}
    求极限
    \[
        \displaystyle\lim\limits_{x\to+\infty}\dfrac{1}{x}\int_0^x|\sin t|\,\mathrm{d}t.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^\pi|\sin t|\,\mathrm{d}t=2,
    \]
    故
    \[
        \displaystyle\int_0^x|\sin t|\,\mathrm{d}t=2k+O(1).
    \]
    又 $x=k\pi+O(1)$,所以
    \[
        \displaystyle\lim\limits_{x\to+\infty}\dfrac{1}{x}
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 对 $0\leq x<1$,有 $x^n\to0$,故 $e^{x^n}\to1$;同时 $1\leq e^{x^n}\leq e$.由控制收敛定理,
              \[
                  \displaystyle\lim\limits_{n\to\infty}\int_0^1e^{x^n}\,\mathrm{d}x
...
\begin{solution}
    ...
    \begin{enumerate}
        \item 固定 $c\in(0,\delta)$.由严格递减性,
              \[
                  \displaystyle\int_\delta^1[f(x)]^n\,\mathrm{d}x
                  \leq(1-\delta)[f(\delta)]^n,
              \]
              而
              \[
                  \displaystyle\int_0^\delta[f(x)]^n\,\mathrm{d}x
                  \geq c[f(c)]^n.
              \]
...
\begin{solution}
    ...
    \[
        \displaystyle\int_Jg(x)\,\mathrm{d}x>0.
    \]
    于是
    \[
        \left[\int_a^b f(x)^ng(x)\,\mathrm{d}x\right]^{\frac{1}{n}}
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{h\to0^+}\int_0^1\dfrac{h}{h^2+x^2}f(x)\,\mathrm{d}x
        =\dfrac{\pi}{2}f(0).
    \]
\end{example}
\exampleblank
...
\begin{example}
    设 $f$ 为连续函数,证明:
    \[
        \displaystyle\lim\limits_{n\to\infty}\dfrac{2}{\pi}
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{h\to0}\int_a^b\dfrac{f(x+h)-f(x)}{h}\,\mathrm{d}x
        =f(b)-f(a).
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    试证:
    \[
        \displaystyle\lim\limits_{n\to\infty}nA_n
        =\dfrac{b-a}{2}[f(b)-f(a)].
    \]
\end{example}
\exampleblank
...
\begin{example}[\markstar]
    ...
    试证:
    \[
        \displaystyle\lim\limits_{n\to\infty}n^2B_n
...
\begin{solution}
    ...
    \[
        \displaystyle\int_{m_i-\frac{h}{2}}^{m_i+\frac{h}{2}}f(x)\,\mathrm{d}x
        -hf(m_i)
...
\begin{remark}
    ...
    则
    \[
        \displaystyle\lim\limits_{n\to\infty}n(\ln2-A_n)=\dfrac{1}{4},
        \qquad
...
\begin{example}[\markstar]
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\int_a^b f(x)g(nx)\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_u^v g(nx)\,\mathrm{d}x
    ...
    \[
        \displaystyle\int_a^b f(x)g(nx)\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_u^v[g(nx)-\overline g]\,\mathrm{d}x
        =O\left(\dfrac{1}{n}\right).
    \]
    所以结论先对阶梯函数成立.再用阶梯函数在 $L^1$ 中逼近 Riemann 可积的 $f$,并利用 $g$ 的有界性控制逼近误差,得到
    \[
        \displaystyle\int_a^b f(x)[g(nx)-\overline g]\,\mathrm{d}x\longrightarrow0.
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\lim\limits_{n\to\infty}\int_0^1 f(x)s(nx)\,\mathrm{d}x=0.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    ...
    故
    \[
        \displaystyle\int_0^1s(x)\,\mathrm{d}x=0.
    \]
    对上一题的 Riemann 引理取 $g=s$,$T=1$,便有
    \[
        \displaystyle\lim\limits_{n\to\infty}\int_0^1f(x)s(nx)\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^1R(x)\,\mathrm{d}x=0.
    \]
\end{solution}
...
\begin{example}
    ...
    \[
        \displaystyle\int_a^b g(x)f(x)\,\mathrm{d}x=0,
    \]
    则函数 $f(x)$ 在连续点上恒为零.
\end{example}
\exampleblank
...
\begin{solution}
    在题设中取 $g=f$,得到
    \[
        \displaystyle\int_a^b f(x)^2\,\mathrm{d}x=0.
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\int_{-1}^{1}f(x)g(x)\,\mathrm{d}x=0.
    \]
...
\begin{solution}
    ...
    \[
        \displaystyle\int_{-1}^{1}f(-x)h(x)\,\mathrm{d}x.
    \]
    两式相加得到
    \[
...
\begin{example}[特殊函数逼近]
    ...
    \[
        \displaystyle\int_a^b|f(x)-g(x)|\,\mathrm{d}x<\varepsilon,
    \]
    其中的 $g$ 是:
    \begin{enumerate}
        \item 阶梯函数;
...
\begin{solution}
    ...
    \begin{enumerate}
        \item 由 $f$ 的 Riemann 可积性,可取一个分割及各小区间中的取样点,使相应阶梯函数 $g_1$ 满足
              \[
                  \displaystyle\int_a^b|f(x)-g_1(x)|\,\mathrm{d}x<\varepsilon.
              \]

        \item 阶梯函数只有有限个跳跃点.在每个跳跃点两侧取互不相交,总长度充分小的区间,并在这些区间内用线段连接左右常值,得到折线函数 $g_2$.因各函数有界,可使
              \[
                  \displaystyle\int_a^b|g_1-g_2|\,\mathrm{d}x
              \]
              任意小.
        ...
        \item 在折线函数的有限个折点附近,用光滑圆弧或三次 Hermite 多项式替换折角,并保持这些小邻域总长度充分小,即得连续可微函数 $g_4$,且
              \[
                  \displaystyle\int_a^b|g_2-g_4|\,\mathrm{d}x
              \]
              任意小.
    \end{enumerate}
...
\begin{example}
    \begin{enumerate}
        \item 设 $f(x)$ 在 $\lbrack a,b\rbrack$ 上为正值可积函数,则存在 $\xi\in(a,b)$,使得
              \[
                  \displaystyle\int_a^\xi f(x)\,\mathrm{d}x
        ...
        \item 设 $f\in C(\lbrack a,b\rbrack)$ 且 $\displaystyle\int_a^b f(x)\,\mathrm{d}x=0$,则存在 $\xi\in(a,b)$,使得
              \[
                  \displaystyle\int_a^\xi f(x)\,\mathrm{d}x=f(\xi).
              \]
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{example}
    \begin{enumerate}
        ...
        \item 设 $f(x),g(x)$ 是 $\lbrack a,b\rbrack$ 上的递增连续函数,则
              \[
                  \displaystyle\int_a^bf(x)\,\mathrm{d}x\int_a^bg(x)\,\mathrm{d}x
...
\begin{example}
    ...
    \[
        \displaystyle\int_0^a|f(x)f'(x)|\,\mathrm{d}x
...
\begin{solution}
    ...
    \]
    以 $Q(x)=\displaystyle\int_0^xq$ 作变量可得
    \[
        \displaystyle\int_0^a|ff'|
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 因 $\sin x\leq1$,
              \[
                  \displaystyle\int_{\frac{\pi}{6}}^{\frac{\pi}{2}}
...
\begin{example}
    证明:
    \[
        \displaystyle\int_0^{\sqrt{2\pi}}\sin x^2\,\mathrm{d}x>0.
    \]
\end{example}
\exampleblank
...
\begin{solution}
    令 $t=x^2$,则
    \[
        \displaystyle\int_0^{\sqrt{2\pi}}\sin x^2\,\mathrm{d}x
...
\begin{example}
    ...
    \[
        \displaystyle\int_a^bxf(x)\,\mathrm{d}x
...
\begin{example}
    证明:
    \[
        \displaystyle\int_0^{\frac{\pi}{2}}\dfrac{\cos x}{1+x^2}\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^{\frac{\pi}{2}}g(x)\,\mathrm{d}x=0.
    \]
    由严格 Chebyshev 积分不等式,
    \[
        \displaystyle\int_0^{\frac{\pi}{2}}g(x)h(x)\,\mathrm{d}x>0.
    \]
    展开该式就是题设两个积分之差为正.
\end{solution}
...
\begin{proposition}[\markstar]
    ...
    则
    \[
        \displaystyle\int_a^bf^{(2n)}(x)g(x)\,\mathrm{d}x
...
\begin{solution}
    ...
    因 $f'\geq0$,
    \[
        \displaystyle\int_0^{2\pi}f'(x)\,\mathrm{d}x=f(2\pi)-f(0).
    \]
    对前式取绝对值便得
    \[
        \left|\int_0^{2\pi}f(x)\sin nx\,\mathrm{d}x\right|
...
\begin{solution}
    ...
    但
    \[
        \displaystyle\int_2^4f(x)\,\mathrm{d}x
...
\begin{example}
    ...
    \[
        \displaystyle\int_0^1\left|\dfrac{f''(x)}{f(x)}\right|\,\mathrm{d}x\geq4.
    \]
\end{example}
\exampleblank
...
\begin{example}
    ...
    且
    \[
        \displaystyle\int_0^1x^n f(x)\,\mathrm{d}x=1.
    \]
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^1P(x)f(x)\,\mathrm{d}x=2^n.
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\int_0^{\frac{\pi}{2}}f(x)\sin x\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^{\frac{\pi}{2}}f(x)(\sin x+\cos x)\,\mathrm{d}x\neq0,
    \]
    这与两个已知积分之和为零矛盾.
    ...
    处处同号,且乘积不恒为零.因此
    \[
        \displaystyle\int_0^{\frac{\pi}{2}}f(x)\sin(x-c)\,\mathrm{d}x\neq0.
    \]
...
\begin{solution}
    ...
    \[
        \displaystyle\int_a^bp(x)\varphi(f(x))\,\mathrm{d}x
        \geq P\varphi(\mu),
    \]
...
\begin{theorem}[\markstar\ Holder 不等式]
    ...
    \[
        \displaystyle\int_a^b|f(x)g(x)|\,\mathrm{d}x
        \leq
...
\begin{example}
    ...
    \[
        \displaystyle\int_0^1\dfrac{f(x)}{1-f(x)}\,\mathrm{d}x
        \geq
...
\begin{example}
    设 $a>0$,证明:
    \[
        \displaystyle\int_0^\pi x^a\sin x\,\mathrm{d}x
...
\begin{solution}
    ...
    并且
    \[
        \displaystyle\int_0^{\frac{\pi}{2}}a^{-\cos x}\,\mathrm{d}x
        =\dfrac{\pi}{2}.
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\int_0^1f^2(x)\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^1f(x)^2\,\mathrm{d}x
        \geq4\left(\int_0^1f(x)\,\mathrm{d}x\right)^2.
    \]
\end{solution}
...
\begin{theorem}[\markstar\ 第一积分中值定理]
    ...
    \begin{enumerate}
        \item (强化形式)存在 $\xi\in(a,b)$,使得
              \[
                  \displaystyle\int_a^bf(x)\,\mathrm{d}x=f(\xi)(b-a).
              \]
        \item (推广形式)设 $g(x)$ 在 $\lbrack a,b\rbrack$ 上可积且不变号,则存在 $\xi\in(a,b)$,使得
              \[
                  \displaystyle\int_a^bf(x)g(x)\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_0^{\frac{1}{4}}[f(t)-C]\,\mathrm{d}t=0,
    \]
...
\begin{example}
    ...
    \[
        \displaystyle\int_a^b\varphi_n(x)\,\mathrm{d}x=1.
    \]
    证明:存在自然数 $N$ 及定数 $c_1,c_2,\ldots,c_N$,使得
    \[
        \displaystyle\sum\limits_{k=1}^N c_k^2=1,
        \qquad
...
\begin{solution}
    ...
    则
    \[
        \displaystyle\int_a^bF_N(x)\,\mathrm{d}x
...
\begin{solution}
    ...
    \[
        \displaystyle\int_x^{x+2}t\sin\dfrac{3}{t}f(t)\,\mathrm{d}t
...
\begin{example}
    ...
    \begin{enumerate}
        \item 存在 $\theta\in(0,1)$,使得
              \[
                  \displaystyle\int_0^1f(x)\,\mathrm{d}x=\theta f(0)+(1-\theta)f(1);
              \]
        \item 对任意 $c>f(0)$,存在 $\theta\in(0,1)$,使得
              \[
                  \displaystyle\int_0^1f(x)\,\mathrm{d}x=\theta c+(1-\theta)f(1).
              \]
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{example}
    ...
    \[
        \displaystyle\int_a^b\cos f(x)\,\mathrm{d}x\leq\dfrac{2}{f'(b)}.
    \]
\end{example}
\exampleblank
...
\begin{example}
    \begin{enumerate}
        ...
        \item 设 $e^2<a<b$,证明:
              \[
                  \displaystyle\int_a^b\dfrac{\mathrm{d}x}{\ln x}<\dfrac{2b}{\ln b};
              \]
        \item 设 $0<a<b$,证明:
              \[
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 当 $x>e^2$ 时,
              ...
              因此
              \[
                  \displaystyle\int_a^b\dfrac{\mathrm{d}x}{\ln x}
...
\begin{example}
    ...
    \begin{enumerate}
        \item
              \[
                  \displaystyle\int_0^1\dfrac{\mathrm{d}x}{1+x^n}
                  =1-\dfrac{k^2}{n}+o(1),
                  \qquad n\to\infty;
              \]
        \item
              \[
                  \displaystyle\lim\limits_{x\to0}\dfrac{1}{x}\int_x^{2x}\sin\dfrac{1}{t}\,\mathrm{d}t=0;
              \]
        \item 当 $\alpha<2$ 时,
              \[
                  \displaystyle\lim\limits_{x\to0^+}\dfrac{1}{x^\alpha}\int_0^x\sin\dfrac{1}{t}\,\mathrm{d}t=0.
              \]
    \end{enumerate}
\end{example}
\exampleblank
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 令 $t=xs$,则原式化为
              \[
                  \displaystyle\int_1^2\sin\dfrac{1}{xs}\,\mathrm{d}s.
              \]
        ...
        \item 令 $u=\dfrac{1}{t}$,则
              \[
                  \displaystyle\int_0^x\sin\dfrac{1}{t}\,\mathrm{d}t
