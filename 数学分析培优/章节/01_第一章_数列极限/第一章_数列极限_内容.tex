...
\begin{corollary}[\markstar]
  设 $I\subseteq\mathbb R$ 为闭区间,$f:I\to I$ 在 $I$ 上连续,在 $I$ 的内部可微.
  若存在常数 $0<r<1$,使得
  \[
    |f'(x)|\leq r
  \]
  对一切 $I$ 的内点 $x$ 成立,则 $f$ 在 $I$ 上存在唯一不动点 $x^*$,且对任意
  $x_1\in I$,由
  \[
    x_{n+1}=f(x_n)
  \]
...
\begin{solution}
  令 $f(x)=\dfrac{1}{1+x}$.从 $x_2=\dfrac{1}{2}$ 开始,
  \[
  ...
  \]
  正不动点满足 $x=\dfrac{1}{1+x}$,故
  \[
    c=\dfrac{\sqrt5-1}{2}.
  \]
  由压缩估计 $|x_{n+1}-c|\leq\dfrac{4}{9}|x_n-c|$,得到
  \[
