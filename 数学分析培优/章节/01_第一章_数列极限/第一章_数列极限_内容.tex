...
\begin{example}
  ...
  \begin{enumerate}
    ...
    \item 设 $\displaystyle \lim\limits_{n\to\infty}x_n=A$,则
          \[
            \displaystyle\lim\limits_{n\to\infty}\dfrac{x_1+x_2+\cdots+x_n}{n}=A.
          \]
  \end{enumerate}
\end{example}
\exampleblank
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{p_n}{p_1+p_2+\cdots+p_n}=0,
    \qquad
...
\begin{example}
  ...
  试证:
  \[
    \displaystyle\lim\limits_{n\to\infty}x_n=a\qquad(a>0).
  \]
\end{example}
\exampleblank
...
\begin{remark}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\sum\limits_{i=1}^n
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{1}{2^n}
    \left(
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{x\to0}\dfrac{f(x)}{g(x)}=1,
  \]
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\sum\limits_{m=1}^n f(\alpha_{mn})
    =
...
\begin{theorem}[\markstar\ Toeplitz 定理]
  ...
  \[
    \displaystyle\sum\limits_{k=1}^n t_{nk}=1,
    \qquad
  ...
  则
  \[
    \displaystyle\lim\limits_{n\to\infty}x_n=a.
  \]
\end{theorem}
...
\begin{solution}
  ...
  \[
    ...
    =\dfrac{\displaystyle\sum\limits_{k=1}^n d_kc_k}{\displaystyle\sum\limits_{k=1}^n d_k}.
  \]
...
\begin{solution}
  由分部求和公式,
  \[
    \displaystyle\sum\limits_{k=1}^n p_ka_k
...
\begin{solution}
  ...
  \[
    \displaystyle\sum\limits_{j=1}^n|t_{nj}|
...
\begin{solution}
  ...
  再由 $x^{-\frac{1}{2}}$ 递减,
  \[
    \displaystyle\sum\limits_{k=1}^n\dfrac{1}{\sqrt k}
...
\begin{example}
  若存在极限
  \[
    \displaystyle\lim\limits_{n\to\infty}(a\sin n+b\cos n)=A,
  \]
  则 $a=b=0$.
\end{example}
\exampleblank
...
\begin{example}
  求下列数列 $\{a_n\}$ 的极限 $\displaystyle \lim\limits_{n\to\infty}a_n$:
  \begin{enumerate}
    \item $\displaystyle a_n=\sqrt[n]{1+b^n}\,(b>0)$;
    \item $\displaystyle a_n=\sqrt[n]{1+b^n+\left(\dfrac{b^2}{2}\right)^n}\,(b>0)$.
  \end{enumerate}
\end{example}
\exampleblank
...
\begin{example}[\markstar]
  ...
  求
  \[
    \displaystyle\lim\limits_{n\to\infty}\sqrt[n]{a_1^n+a_2^n+\cdots+a_m^n}.
  \]
\end{example}
\exampleblank
...
\begin{example}[\markstar]
  ...
  求证:
  \[
    \displaystyle\lim\limits_{n\to\infty}\left(\sum\limits_{k=1}^n a_k^n\right)^{\frac{1}{n}}=a.
  \]
\end{example}
\exampleblank
...
\begin{example}
  ...
  \begin{enumerate}
    ...
    \item $\displaystyle a_n=\dfrac{\displaystyle\sqrt[n]{\sum\limits_{k=1}^n k^n}}{n}$;
...
\begin{solution}
  ...
  (2) 同理,
  \[
    \displaystyle\sum\limits_{k=1}^n\dfrac{\sin\dfrac{k\pi}{n}}{n+\dfrac{k}{n}}
  ...
  \[
    \displaystyle\int_0^1\sin(\pi x)\,\mathrm{d}x=\dfrac{2}{\pi}.
  \]
\end{solution}
...
$\displaystyle\sum\limits_{n=1}^{\infty}(x_{n+1}-x_{n})$
绝对收敛 $\Rightarrow$
...
\begin{solution}
  ...
  (1) 由 Stirling 公式 $n!\sim\sqrt{2\pi n}\left(\dfrac{n}{e}\right)^n$,有
  \[
...
\begin{solution}
  ...
  故 $\{x_n\}$ 最终单调递减.另一方面,
  \[
    \displaystyle\sum\limits_{k=2}^n f(k)
...
\begin{solution}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{S_n}{n^{p+1}}
    =\lim\limits_{n\to\infty}
  ...
  故上式等于
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{1}{p+1}\left(\dfrac{n+1}{\xi_n}\right)^p
    =\dfrac{1}{p+1}.
  \]
\end{solution}
...
\begin{example}
  ...
  \begin{enumerate}
    \item $\displaystyle
            ...
            \,\text{(其中 }a_k\to a\,(k\to\infty)\text{)}$;
    \item $\displaystyle
            I=\lim\limits_{n\to\infty}\dfrac{\displaystyle\sum\limits_{k=1}^n\dfrac{1}{k}}{\ln n}$;
    \item $\displaystyle
...
\begin{solution}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{S_n}{\sqrt n}
    =\lim\limits_{n\to\infty}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{H_n}{\ln n}
    =\lim\limits_{n\to\infty}
...
\begin{example}
  设
  \[
    S_n=\dfrac{\displaystyle\sum\limits_{k=0}^n\ln C_{n}^{k}}{n^2},
  \]
...
\begin{example}
  设
  \[
    \displaystyle\lim\limits_{n\to\infty}\sum\limits_{k=1}^n\dfrac{1}{k^2}=m,
  \]
  求极限
  \[
    \displaystyle\lim\limits_{n\to\infty}
...
\begin{example}
  设
  \[
    \displaystyle\lim\limits_{n\to\infty}n(A_n-A_{n-1})=0,
  \]
  试证:当
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{A_1+A_2+\cdots+A_n}{n}.
  \]
  存在时,
  \[
    \displaystyle\lim\limits_{n\to\infty}A_n
    =
...
\begin{example}
  ...
  证明:
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{a_n}{\sqrt{2n}}=1.
  \]
\end{example}
\exampleblank
...
\begin{solution}
  ...
  则令 $n\to\infty$ 会得到 $L=L+\dfrac{1}{L}$,矛盾.所以 $a_n\to+\infty$.平方递推式得
  \[
    a_{n+1}^2-a_n^2=2+\dfrac{1}{a_n^2}\longrightarrow2.
  \]
  对 $a_n^2$ 与 $n$ 使用 Stolz 定理,
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{a_n^2}{n}=2.
  \]
  由于 $a_n>0$,故
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{a_n}{\sqrt{2n}}=1.
...
\begin{example}
  ...
  证明:
  \[
    \displaystyle\lim\limits_{n\to\infty}\sqrt{\dfrac{n}{3}}\,a_n=1.
  \]
\end{example}
\exampleblank
...
\begin{solution}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}na_n^2
    =\lim\limits_{n\to\infty}
...
\begin{solution}
  ...
  得
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{\dfrac{1}{a_n}-n}{\ln n}
    =\lim\limits_{n\to\infty}
  ...
  因此
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{n(1-na_n)}{\ln n}=1\cdot1=1.
  \]
\end{solution}
...
\begin{example}
  ...
  则
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{n(na_n-2)}{\ln n}=\dfrac{2}{3}.
  \]
\end{example}
\exampleblank
...
\begin{solution}
  ...
  于是 $\dfrac{1}{a_n}$ 严格递增且趋于 $+\infty$.先把 $na_n$ 写成商
  \[
    na_n=\dfrac{n}{\dfrac{1}{a_n}},
  \]
  ...
  于是
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{n-\dfrac{2}{a_n}}{\ln n}
    =\lim\limits_{n\to\infty}
  ...
  其中最后一步用了 $na_n\to2$.因此
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{n(na_n-2)}{\ln n}
...
\begin{corollary}
    设 $I\subseteq\mathbb{R}$ 为非空连通闭集,$f:I\to I$.
    若存在常数 $0<r<1$,使得对任意 $x,y\in I$,
    \[
        |f(x)-f(y)|\leq r|x-y|,
    \]
    则 $f$ 在 $I$ 上存在唯一不动点 $x^*$,且对任意 $x_0\in I$,
    由
    \[
    ...
    特别地,若 $f\in C(I)$,且 $f$ 在 $I$ 的内部可微,并存在常数
    $0<r<1$,使得
    \[
        |f'(x)|\leq r,\qquad x\in I^\circ,
    \]
    则上述结论成立.
\end{corollary}
...
\begin{solution}
  ...
  故
  \[
    \displaystyle\lim\limits_{n\to\infty}x_n=\sqrt c.
  \]
...
\begin{solution}
  ...
  $\lbrack a,b\rbrack$ 映入自身.对任意 $x<y$,由
  \[
    |f(y)-f(x)|\leq y-x
  \]
  可得
  ...
  若 $x_2\geq x_1$,则由 $x_{n+1}=g(x_n)$ 及 $g$ 的单调性,归纳可得
  \[
...
\begin{example}
  设 $\{a_n\}$ 满足
  \[
    \displaystyle\lim\limits_{n\to\infty}(a_n-2a_{n+1})=A,
  \]
  证明:$\{a_n\}$ 收敛并求其极限.
\end{example}
\exampleblank
...
\begin{example}
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}n(b_n+b_{2n})=l,
  \]
  证明:$\{a_n\}$ 收敛,并求其极限.
\end{example}
\exampleblank
...
\begin{solution}
  ...
  仍有 $0<a_{n+1}<1$.故从第二项起数列位于 $(0,1)$ 内.记
  \[
...
\begin{example}
  讨论下列数列 $\{a_n\}$ 的敛散性:
  \begin{enumerate}
    \item $\displaystyle a_{n+1}=\sqrt[3]{a_n+6}\,(a_1>-6)$;
    \item $\displaystyle a_{n+1}=A\sqrt{a_n}+B\,(A,B>0,\,a_1>0)$.
  \end{enumerate}
\end{example}
\exampleblank
...
\begin{solution}
  ...
  从而
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{a_n}{n}
    =\alpha.
  \]
  ...
  \[
    \displaystyle\lim\limits_{n\to\infty}\sqrt[n]{a_n}=0.
  \]
  ...
  因此由第 (1) 问,
  \[
    \displaystyle\lim\limits_{n\to\infty}\dfrac{b_n}{n}
  \]
  存在.又因为
  \[
    \sqrt[n]{a_n}
