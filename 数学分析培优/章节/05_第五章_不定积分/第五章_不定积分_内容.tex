...
\begin{theorem}[\markstar\ 部分初等函数积分公式]
    ...
    \begin{enumerate}
        ...
        \item $\displaystyle\int a^x\,\mathrm{d}x=\dfrac{a^x}{\ln a}+C\,(a>0,a\neq1)$;
...
\begin{example}
    求下列不定积分:
    \begin{enumerate}
        \item $\displaystyle I=\int\dfrac{a^x-a^{-x}}{a^x+a^{-x}}\,\mathrm{d}x\,(a>0)$;
        \item $\displaystyle I=\int\dfrac{\ln x+1}{1+x\ln x}\,\mathrm{d}x$;
        \item $\displaystyle I=\int\dfrac{\sin2x}{a^2\sin^2x+b^2\cos^2x}\,\mathrm{d}x\,(a^2\neq b^2)$;
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item 令 $y=\sqrt{1+x^2}/x$,则
              ...
              \]
        \item $\displaystyle I=\arccos\dfrac{1}{|x|}+C\,(|x|>1)$.
    \end{enumerate}
\end{solution}
